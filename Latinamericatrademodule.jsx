...
// ============================================
// 🌎 COMPLETE LATIN AMERICA TRADE MODULE
...
export default function LatinAmericaTrade() {
  ...
  const productsDatabase = [
    ...
    { id: 31, name: 'Pepper - Jalapeño', category: 'Vegetable', origin: 'Mexico', hsCode: '0709.60', price: 18.50, unit: 'lb' },
  ...
  // ========================================
  const tabs = [
    { id: 'search', label: '🔍 Produce Search', icon: Search },
    { id: 'pricing', label: '💰 Price Calculator', icon: Calculator },
    { id: 'buyers', label: '👥 Buyers Network', icon: Users },
    { id: 'factoring', label: '💳 Factoring', icon: CreditCard },
    { id: 'po-finance', label: '📄 P.O. Finance', icon: FileText },
