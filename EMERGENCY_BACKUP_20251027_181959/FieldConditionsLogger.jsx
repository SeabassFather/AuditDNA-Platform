...
export default function FieldConditionsLogger({ 
  ...
  const handleSubmit = () => {
    ...
    if (sampleType === 'soil' && !conditions.soilTempSurface) {
      alert('ÃƒÂ¢Ã…Â¡Ã‚Â ÃƒÂ¯Ã‚Â¸Ã‚Â Soil surface temperature required for soil samples!');
      return;
    }
    if (sampleType === 'water' && !conditions.waterTemp) {
      alert('ÃƒÂ¢Ã…Â¡Ã‚Â ÃƒÂ¯Ã‚Â¸Ã‚Â Water temperature required for water samples!');
      return;
    }
    if (!conditions.airTemp || !conditions.humidity) {
      alert('ÃƒÂ¢Ã…Â¡Ã‚Â ÃƒÂ¯Ã‚Â¸Ã‚Â Air temperature and humidity required!');
      return;
    }
    ...
    <div style={{
      ...
      <div style={{marginBottom: '25px'}}>
        <h2 style={{color: '#10b981', fontSize: '1.5rem', marginBottom: '10px'}}>
          ÃƒÂ°Ã…Â¸Ã…â€™Ã‚Â¡ÃƒÂ¯Ã‚Â¸Ã‚Â Field Conditions at Time of Sample
        </h2>
      ...
      <div style={{
        ...
        >
          ÃƒÂ°Ã…Â¸Ã¢â‚¬Â¢Ã¢â‚¬â„¢ Update to Now
        </button>
      </div>
      ...
      {sampleType === 'soil' && (
        <div style={{
          ...
          <h3 style={{color: '#fbbf24', fontSize: '1.2rem', marginBottom: '15px'}}>
            ÃƒÂ°Ã…Â¸Ã…â€™Ã‚Â± Soil Temperature Profile
          </h3>
      ...
      {sampleType === 'water' && (
        <div style={{
          ...
          <h3 style={{color: '#06b6d4', fontSize: '1.2rem', marginBottom: '15px'}}>
            ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Â§ Water Sample Conditions
          </h3>
          <div style={{display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '15px'}}>
            <div>
              <label style={{display: 'block', marginBottom: '5px', color: '#94a3b8', fontSize: '0.85rem'}}>
                Water Temp (Ãƒâ€šÃ‚Â°F) *
              </label>
              <input
                type="number"
                step="0.1"
      ...
      <div style={{
        ...
        <h3 style={{color: '#10b981', fontSize: '1.2rem', marginBottom: '15px'}}>
          ÃƒÂ°Ã…Â¸Ã…â€™Ã‚Â¡ÃƒÂ¯Ã‚Â¸Ã‚Â Air Temperature & Humidity
        </h3>
        <div style={{display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '15px'}}>
          <div>
            <label style={{display: 'block', marginBottom: '5px', color: '#94a3b8', fontSize: '0.85rem'}}>
      ...
      <div style={{
        ...
        <h3 style={{color: '#3b82f6', fontSize: '1.2rem', marginBottom: '15px'}}>
          ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Â¨ Wind Conditions
        </h3>
        <div style={{display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '15px'}}>
          <div>
            <label style={{display: 'block', marginBottom: '5px', color: '#94a3b8', fontSize: '0.85rem'}}>
      ...
      <div style={{
        ...
        <h3 style={{color: '#8b5cf6', fontSize: '1.2rem', marginBottom: '15px'}}>
          ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã…Â  Barometric Pressure & Precipitation
        </h3>
        <div style={{display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '15px'}}>
          <div>
            <label style={{display: 'block', marginBottom: '5px', color: '#94a3b8', fontSize: '0.85rem'}}>
          ...
          <div>
            ...
            >
              <option value="">Select...</option>
              <option value="rising">Rising ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â€</option>
              <option value="steady">Steady ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢</option>
              <option value="falling">Falling ÃƒÂ¢Ã¢â‚¬Â Ã‹Å“</option>
            </select>
          </div>
          <div>
            <label style={{display: 'block', marginBottom: '5px', color: '#94a3b8', fontSize: '0.85rem'}}>
      ...
      <div style={{
        ...
        <h3 style={{color: '#94a3b8', fontSize: '1.2rem', marginBottom: '15px'}}>
          ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â§ Measurement Equipment
        </h3>
      ...
      <div style={{
        ...
        <h3 style={{color: '#94a3b8', fontSize: '1.2rem', marginBottom: '15px'}}>
          ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â Field Observations
        </h3>
        <div>
          <label style={{display: 'block', marginBottom: '5px', color: '#94a3b8', fontSize: '0.85rem'}}>
            Additional Notes
      ...
      >
        ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Save Field Conditions & Continue
      </button>
