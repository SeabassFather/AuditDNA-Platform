...
export const soilTestCatalog = [
  ...
  { id: 'soil-bacteria-total', name: 'Total Bacterial Count', category: 'Microbial', price: 85, popular: true, description: 'Enumerate total bacteria (target 10Ã¢ÂÂ¸-10Ã¢ÂÂ¹ cells/g)', parameters: ['Total Bacteria', 'CFU'], tags: ['microbial', 'biology', 'SG protocol'] },
  { id: 'soil-fungi-total', name: 'Total Fungal Count', category: 'Microbial', price: 85, popular: true, description: 'Fungal biomass (target 10Ã¢ÂÂµ-10Ã¢ÂÂ¶ propagules/g)', parameters: ['Total Fungi', 'Propagules'], tags: ['microbial', 'biology'] },
  { id: 'soil-protozoa', name: 'Protozoa Enumeration', category: 'Microbial', price: 95, description: 'Bacterial regulators (target 10Ã¢ÂÂ´-10Ã¢ÂÂµ/g)', parameters: ['Protozoa', 'Count'], tags: ['microbial', 'biology'] },
  ...
  { id: 'soil-pathogen-fusarium', name: 'Fusarium Pathogen Test', category: 'Microbial', price: 110, description: 'Root rot pathogen (target < 10Ã‚Â³ cfu/g)', parameters: ['Fusarium'], tags: ['pathogen', 'disease', 'risk'] },
  { id: 'soil-pathogen-pythium', name: 'Pythium Pathogen Test', category: 'Microbial', price: 110, description: 'Water mold pathogen (target < 10Ã‚Â³ cfu/g)', parameters: ['Pythium'], tags: ['pathogen', 'disease'] },
  ...
  { id: 'soil-respiration', name: 'Soil Respiration (CO2)', category: 'Microbial', price: 75, description: 'Biological activity (target > 1.5 mg COÃ¢â€šâ€š-C/g/day)', parameters: ['Respiration', 'CO2'], tags: ['activity', 'biology'] },
  { id: 'soil-enzymes', name: 'Enzyme Activity Panel', category: 'Microbial', price: 135, description: 'ÃŽÂ²-glucosidase, phosphatase, urease', parameters: ['Enzymes', 'Activity'], tags: ['biochemical', 'activity'] },
  { id: 'soil-beneficial-ratio', name: 'Beneficial:Pathogenic Ratio', category: 'Microbial', price: 150, popular: true, description: 'Microbe balance assessment (target Ã¢â€°Â¥ 10:1)', parameters: ['Ratio', 'Balance'], tags: ['microbial', 'health', 'SG protocol'] },
