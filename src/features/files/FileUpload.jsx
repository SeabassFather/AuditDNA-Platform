...
export default function FileUpload() {
  ...
  async function startUpload() {
    ...
    setStatus("Requesting pre-signed URLÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¦");
    ...
    setStatus("Uploading to storageÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¦");
    ...
    setStatus("Confirming with backendÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¦");
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-6">
      ...
      <p className="text-xs text-gray-500 mt-2">
        ...
        Expected backend: <code>POST /files/presign</code> ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢{" "}
        <code>PUT uploadUrl</code> ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ <code>POST /files/confirm</code>.
      </p>
    </div>
  );
}
