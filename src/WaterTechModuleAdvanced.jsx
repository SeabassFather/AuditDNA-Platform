...
const WaterTechModuleAdvanced = () => {
  ...
  const handleAddToCart = () => {
    if (!uploadedFile) {
      alert(language === 'es' 
        ? 'Por favor sube tus resultados de laboratorio primero' 
        : 'Please upload your lab results first'
      );
      return;
    }
    ...
    const analysisService = {
      ...
      name: language === 'es' 
        ? 'Análisis Completo de Agua con IA' 
        : 'Complete Water Analysis with AI',
      price: 149.00,
                ...
                <div style={{ 
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: '1rem', color: '#b0bec5' }}>
                      {language === 'es' ? 'Análisis completo' : 'Complete analysis'}
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: '1rem', color: '#b0bec5' }}>
                      {language === 'es' ? 'Entrega' : 'Turnaround'}
                    </div>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div style={{ 
                  ...
                  <span style={{ 
                    fontSize: '0.7rem', 
                    padding: '0.2rem 0.5rem', 
                    background: `${riskColors[param.riskLevel]}20`, 
                    borderRadius: '8px', 
                    color: riskColors[param.riskLevel] 
                  }}>
                    {param.riskLevel}
                  </span>
                </div>
