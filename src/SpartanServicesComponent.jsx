...
export default function Services() {
  ...
  const getCategoryIcon = (category) => {
    const iconMap = {
      'Agriculture & Food Systems': 'ðŸŒ¾',
      'Mortgage & Real Estate': 'ðŸ ',
      'Legal & Compliance': 'âš–ï¸',
      'Finance & Factoring': 'ðŸ’°',
      'Education & Workforce': 'ðŸŽ“',
      'Eco & Sustainability': 'ðŸŒ',
      'Healthcare & Insurance': 'ðŸ¥',
      'Global Trade & Logistics': 'ðŸŒ',
      'Technology & Data': 'ðŸ’»',
      'Consumer & Retail': 'ðŸ›’'
    };
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="p-3 bg-blue-50 rounded-lg">
                    <span className="text-2xl">{cat.icon || 'ðŸ› ï¸'}</span>
                  </div>
                  <div>
