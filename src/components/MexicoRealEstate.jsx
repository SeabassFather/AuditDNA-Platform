...
export default function MexicoRealEstateAccordion() {
  ...
  const labels = {
    english: {
      ...
      sub: "Bienes RaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­ces en MÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©xico ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ Full Service Platform",
    ...
    spanish: {
      ...
      toggle: "EspaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â±ol",
    },
    spanish: {
      header: "Bienes RaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­ces MÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©xico",
      sub: "Mexico Real Estate ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ Plataforma de Servicio Completo",
      search: "Buscar Propiedades",
      // contactOwner: "Contactar al Propietario", // Removed
      buyerForm: "Solicitud de InformaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n / InterÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©s de Compra",
      upload: "Publicar Propiedad",
      refi: "Refinanciamiento / Compra en MÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©xico (Solo Ciudadanos USA)",
      partner: "Registro de Socio de Referencia",
      agent: "Registro de Agente",
      appraisal: "Servicios de AvalÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Âºo",
      legal: "Cuestionario Legal/Fideicomiso",
      contact: "InformaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n de Contacto",
      toggle: "English",
    },
  };
