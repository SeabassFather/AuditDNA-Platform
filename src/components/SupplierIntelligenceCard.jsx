      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '24px' }}>
        <div style={{ background: '#fff', borderRadius: '12px', boxShadow: '0 4px 6px rgba(0,0,0,0.1)', padding: '40px', textAlign: 'center' }}>
          <h1 style={{ fontSize: '36px', fontWeight: 'bold', color: '#1f2937', marginBottom: '16px' }}>
            Ã°Å¸Å½Â¯ Supplier Intelligence Search
            ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã‚Â½Ãƒâ€šÃ‚Â¯ Supplier Intelligence Search
          </h1>
          ...
          <div style={{ maxWidth: '700px', margin: '0 auto', marginBottom: '32px' }}>
            <div style={{ display: 'flex', gap: '12px' }}>
              ...
              >
                {isSearching ? 'Ã°Å¸â€Â Searching...' : 'Ã°Å¸â€Â Search'}
                {isSearching ? 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â Searching...' : 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â Search'}
              </button>
            </div>
          </div>
          ...
          <div style={{ marginTop: '48px', display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '24px', textAlign: 'left' }}>
            <div style={{ padding: '24px', background: '#f9fafb', borderRadius: '8px' }}>
              ...
              <div style={{ fontSize: '32px', marginBottom: '12px' }}>ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‹Å“Ãƒâ€šÃ‚Â¥</div>
            ...
            <div style={{ padding: '24px', background: '#f9fafb', borderRadius: '8px' }}>
              <div style={{ fontSize: '32px', marginBottom: '12px' }}>Ã°Å¸Å¡Â¢</div>
              <div style={{ fontSize: '32px', marginBottom: '12px' }}>ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã‚Â¡Ãƒâ€šÃ‚Â¢</div>
            ...
            <div style={{ padding: '24px', background: '#f9fafb', borderRadius: '8px' }}>
              <div style={{ fontSize: '32px', marginBottom: '12px' }}>Ã°Å¸â€œÅ </div>
              <div style={{ fontSize: '32px', marginBottom: '12px' }}>ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€¦Ã‚Â </div>
    ...
    return (
      <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '24px' }}>
        <div style={{ marginBottom: '24px' }}>
          ...
          >
            Ã¢â€ Â Back to Search
            ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Ãƒâ€šÃ‚Â Back to Search
          </button>
        </div>
              ...
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
                  <div>
                    ...
                    <div style={{ display: 'flex', gap: '16px', fontSize: '14px', color: '#6b7280', marginBottom: '12px' }}>
                      <span>Ã°Å¸â€œÂ {supplier.location}</span>
                      <span>Ã°Å¸ÂÂ¢ Est. {supplier.established}</span>
                      <span>Ã°Å¸â€™Â° {supplier.annualRevenue}</span>
                      <span>ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€šÃ‚Â {supplier.location}</span>
                      <span>ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€šÃ‚ÂÃƒâ€šÃ‚Â¢ Est. {supplier.established}</span>
                      <span>ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢Ãƒâ€šÃ‚Â° {supplier.annualRevenue}</span>
                    </div>
                    <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                      {supplier.certifications.map((cert, idx) => (
                        <span key={idx} style={{ padding: '4px 12px', background: '#d1fae5', color: '#065f46', borderRadius: '12px', fontSize: '12px' }}>
                          Ã¢Å“â€¦ {cert}
                          ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã¢â‚¬Å“ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦ {cert}
                        </span>
                      ))}
                    </div>
                  </div>
                ...
                <div style={{ marginTop: '12px', textAlign: 'right' }}>
                  <button style={{ padding: '8px 16px', background: '#2563eb', color: '#fff', border: 'none', borderRadius: '6px', fontSize: '14px', fontWeight: 'bold' }}>
                    ...
                    View Full Intelligence ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢
                  </button>
                </div>
              </div>
            );
    ...
    <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '24px' }}>
      ...
      <div style={{ background: '#fff', borderRadius: '12px', boxShadow: '0 4px 6px rgba(0,0,0,0.1)' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
            <div>
              ...
              <div style={{ display: 'flex', gap: '24px', fontSize: '14px', opacity: 0.9 }}>
                <span>Ã°Å¸â€œÂ {supplier.location}</span>
                <span>Ã°Å¸ÂÂ¢ Est. {supplier.established}</span>
                <span>Ã°Å¸Å’Â {supplier.exportVolume}</span>
                <span>ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€šÃ‚Â {supplier.location}</span>
                <span>ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€šÃ‚ÂÃƒâ€šÃ‚Â¢ Est. {supplier.established}</span>
                <span>ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â {supplier.exportVolume}</span>
              </div>
            </div>
            <div style={{ 
              padding: '12px 24px', 
        ...
        <div style={{ padding: '24px', borderTop: '1px solid #e5e7eb' }}>
          ...
          >
            <span>Ã°Å¸â€˜Â¥ Smart Contact Directory</span>
            <span>{expandedSections.contacts ? 'Ã¢â€“Â²' : 'Ã¢â€“Â¼'}</span>
            <span>ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‹Å“Ãƒâ€šÃ‚Â¥ Smart Contact Directory</span>
            <span>{expandedSections.contacts ? 'ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“Ãƒâ€šÃ‚Â²' : 'ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“Ãƒâ€šÃ‚Â¼'}</span>
          </button>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <div>
                <h3 style={{ fontSize: '16px', fontWeight: 'bold', color: '#374151', marginBottom: '12px' }}>
                  Ã°Å¸â€™Â¼ PURCHASING & ORDERS
                  ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢Ãƒâ€šÃ‚Â¼ PURCHASING & ORDERS
                </h3>
                {supplier.contacts.commercial.map((contact, idx) => (
                  <div key={idx} style={{ 
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
                      <div>
                        <div style={{ fontWeight: 'bold', fontSize: '16px' }}>
                          {contact.name} {contact.preferredContact && <span style={{ fontSize: '11px', background: '#059669', color: '#fff', padding: '2px 8px', borderRadius: '10px' }}>Ã¢Â­Â PREFERRED</span>}
                          {contact.name} {contact.preferredContact && <span style={{ fontSize: '11px', background: '#059669', color: '#fff', padding: '2px 8px', borderRadius: '10px' }}>ÃƒÆ’Ã‚Â¢Ãƒâ€šÃ‚Â­Ãƒâ€šÃ‚Â PREFERRED</span>}
                        </div>
                    ...
                    <div style={{ fontSize: '13px', marginBottom: '8px' }}>
                      Ã°Å¸â€œÂ§ {contact.email} | Ã°Å¸â€œÂ± {contact.phone}
                    </div>
                    <div style={{ background: '#fff', padding: '12px', borderRadius: '6px', marginBottom: '8px', fontSize: '12px' }}>
                      <strong>Ã¢Å“â€¦ Authorized for:</strong> {contact.authorizedFor.join(', ')}
                    </div>
                    <div style={{ display: 'flex', gap: '8px' }}>
                      ...
                      <button onClick={() => handleGenerateQR(contact)} style={{ padding: '6px 12px', background: '#7c3aed', color: '#fff', border: 'none', borderRadius: '4px', fontSize: '12px', cursor: 'pointer' }}>
                        Ã°Å¸â€œÂ± QR Code
                      ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€šÃ‚Â§ {contact.email} | ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€šÃ‚Â± {contact.phone}
                    </div>
                    <div style={{ background: '#fff', padding: '12px', borderRadius: '6px', marginBottom: '8px', fontSize: '12px' }}>
                      <strong>ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã¢â‚¬Å“ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦ Authorized for:</strong> {contact.authorizedFor.join(', ')}
                    </div>
                    <div style={{ display: 'flex', gap: '8px' }}>
                      <button onClick={() => handleSendEmail(contact, 'PO')} style={{ padding: '6px 12px', background: '#2563eb', color: '#fff', border: 'none', borderRadius: '4px', fontSize: '12px', cursor: 'pointer' }}>
                        ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€šÃ‚Â§ Send PO
                      </button>
                      <button onClick={() => handleGenerateQR(contact)} style={{ padding: '6px 12px', background: '#7c3aed', color: '#fff', border: 'none', borderRadius: '4px', fontSize: '12px', cursor: 'pointer' }}>
                        ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€šÃ‚Â± QR Code
                      </button>
                    </div>
                  </div>
                ))}
              ...
              <div>
                <h3 style={{ fontSize: '16px', fontWeight: 'bold', color: '#374151', marginBottom: '12px' }}>
                  Ã°Å¸â€™Â° FINANCE & PAYMENTS
                  ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢Ãƒâ€šÃ‚Â° FINANCE & PAYMENTS
                </h3>
                {supplier.contacts.financial.map((contact, idx) => (
                  <div key={idx} style={{ background: '#fef3c7', padding: '16px', borderRadius: '8px', borderLeft: '4px solid #d97706' }}>
                    <div style={{ fontWeight: 'bold', fontSize: '16px', marginBottom: '4px' }}>
                      {contact.name} {contact.confidential && <span style={{ fontSize: '11px', background: '#dc2626', color: '#fff', padding: '2px 8px', borderRadius: '10px' }}>Ã°Å¸â€â€™ CONFIDENTIAL</span>}
                    </div>
                    ...
                    <button onClick={() => handleSendEmail(contact, 'Factoring')} style={{ padding: '6px 12px', background: '#d97706', color: '#fff', border: 'none', borderRadius: '4px', fontSize: '12px', cursor: 'pointer' }}>
                      Ã°Å¸â€™Â³ Propose Factoring
                      {contact.name} {contact.confidential && <span style={{ fontSize: '11px', background: '#dc2626', color: '#fff', padding: '2px 8px', borderRadius: '10px' }}>ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ CONFIDENTIAL</span>}
                    </div>
                    <div style={{ fontSize: '13px', color: '#6b7280', marginBottom: '8px' }}>{contact.title}</div>
                    <div style={{ fontSize: '13px', marginBottom: '8px' }}>
                      ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€šÃ‚Â§ {contact.email} | ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€šÃ‚Â± {contact.phone}
                    ...
                    <button onClick={() => handleSendEmail(contact, 'Factoring')} style={{ padding: '6px 12px', background: '#d97706', color: '#fff', border: 'none', borderRadius: '4px', fontSize: '12px', cursor: 'pointer' }}>
                      ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢Ãƒâ€šÃ‚Â³ Propose Factoring
                    </button>
                  </div>
                ))}
              </div>
      ...
      {qrModal && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000 }}>
          <div style={{ background: '#fff', padding: '24px', borderRadius: '12px', textAlign: 'center', maxWidth: '400px' }}>
            <h2 style={{ marginBottom: '16px' }}>Ã°Å¸â€œÂ± QR Code</h2>
            <h2 style={{ marginBottom: '16px' }}>ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€šÃ‚Â± QR Code</h2>
