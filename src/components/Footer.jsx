        ...
        <div className="row align-items-center">
          <div className="col-md-6">
            <p className="text-muted mb-0 small">
              Ã‚Â© 2024 AuditDNA. All rights reserved. | Licensed Financial Services Provider
              ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â© 2024 AuditDNA. All rights reserved. | Licensed Financial Services Provider
            </p>
          </div>
