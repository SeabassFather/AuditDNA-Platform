...
const text = {
  ...
  spanish: {
    ...
    alertText: "Todos los campos son obligatorios. Debe completar este registro antes de poder subir propiedades a la plataforma. Su informaciÃƒÂ³n serÃƒÂ¡ verificada antes de la aprobaciÃƒÂ³n.",
    formTitle: "Formulario de CalificaciÃƒÂ³n de Agente",
    formSubtitle: "Por favor proporcione informaciÃƒÂ³n precisa",
    ...
    questions: "Ã‚Â¿Preguntas sobre el registro?",
    contact: "Contacto: support@auditdna.com",
    required: "es requerido",
    invalidEmail: "El correo electrÃƒÂ³nico no es vÃƒÂ¡lido",
    invalidPhone: "El nÃƒÂºmero de telÃƒÂ©fono no es vÃƒÂ¡lido",
    // Refi
    refiTitle: "Refinanciamiento / Compra en MÃƒÂ©xico (Solo Ciudadanos USA)",
    refiSubtitle: "Exclusivo para ciudadanos estadounidenses que buscan refinanciar o comprar casa en MÃƒÂ©xico. PrÃƒÂ©stamo mÃƒÂ­nimo: $385,000 USD. Anticipo requerido: 35-45%. Aplican otras restricciones.",
    propertyType: "Tipo de Propiedad",
    address: "DirecciÃƒÂ³n de la Propiedad en MÃƒÂ©xico",
    downPayment: "Anticipo (%)",
    loanAmount: "Monto de PrÃƒÂ©stamo Deseado (USD)",
    notes: "Notas Adicionales / Preguntas",
    refiSubmit: "Enviar Solicitud de CrÃƒÂ©dito/Refinanciamiento",
    refiThankyou: "Ã‚Â¡Gracias! Nuestro equipo de crÃƒÂ©dito se comunicarÃƒÂ¡ para los siguientes pasos.",
    invalidLoan: "El monto mÃƒÂ­nimo de prÃƒÂ©stamo es $385,000 USD",
    subtitle: "ÃƒÆ’Ã†â€™Ãƒâ€¦Ã‚Â¡nase a la Plataforma Elite de Bienes RaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­ces AuditDNA",
    alertTitle: "Registro Requerido Antes de Subir Propiedades",
    alertText: "Todos los campos son obligatorios. Debe completar este registro antes de poder subir propiedades a la plataforma. Su informaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n serÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡ verificada antes de la aprobaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n.",
    formTitle: "Formulario de CalificaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n de Agente",
    formSubtitle: "Por favor proporcione informaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n precisa",
    fullName: "Nombre Completo",
    email: "Correo ElectrÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³nico",
    phone: "NÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Âºmero de TelÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©fono",
    agency: "Nombre de la Agencia",
    terms: "Al registrarse, acepta cumplir con todos los tÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©rminos y condiciones de la plataforma, incluido el acuerdo de divisiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n de comisiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n 50/50 en todas las transacciones. Certifica que toda la informaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n proporcionada es precisa y que tiene la autoridad para listar propiedades en nombre de los propietarios.",
    submit: "Completar Registro",
    questions: "ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿Preguntas sobre el registro?",
    contact: "Contacto: support@auditdna.com",
    required: "es requerido",
    invalidEmail: "El correo electrÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³nico no es vÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡lido",
    invalidPhone: "El nÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Âºmero de telÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©fono no es vÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡lido",
    // Refi
    refiTitle: "Refinanciamiento / Compra en MÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©xico (Solo Ciudadanos USA)",
    refiSubtitle: "Exclusivo para ciudadanos estadounidenses que buscan refinanciar o comprar casa en MÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©xico. PrÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©stamo mÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­nimo: $385,000 USD. Anticipo requerido: 35-45%. Aplican otras restricciones.",
    propertyType: "Tipo de Propiedad",
    address: "DirecciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n de la Propiedad en MÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©xico",
    downPayment: "Anticipo (%)",
    loanAmount: "Monto de PrÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©stamo Deseado (USD)",
    notes: "Notas Adicionales / Preguntas",
    refiSubmit: "Enviar Solicitud de CrÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©dito/Refinanciamiento",
    refiThankyou: "ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡Gracias! Nuestro equipo de crÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©dito se comunicarÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡ para los siguientes pasos.",
    invalidLoan: "El monto mÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­nimo de prÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©stamo es $385,000 USD",
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          <div>
            ...
            <input
              ...
              placeholder={language === "english" ? "John Doe" : "Juan PÃƒÂ©rez"}
              placeholder={language === "english" ? "John Doe" : "Juan PÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©rez"}
          ...
          <div>
            ...
            <input
              ...
              value={form.address}
              onChange={handleChange}
              placeholder={language === "english" ? "Mexico, Address" : "DirecciÃƒÂ³n en MÃƒÂ©xico"}
              placeholder={language === "english" ? "Mexico, Address" : "DirecciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n en MÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©xico"}
          ...
          <div>
            ...
            <textarea
              ...
              value={form.notes}
              onChange={handleChange}
              placeholder={language === "english" ? "Tell us more about your needs..." : "CuÃƒÂ©ntenos mÃƒÂ¡s sobre sus necesidades..."}
              placeholder={language === "english" ? "Tell us more about your needs..." : "CuÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©ntenos mÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡s sobre sus necesidades..."}
