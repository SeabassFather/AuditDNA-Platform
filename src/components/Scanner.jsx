      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <ul className="text-sm text-blue-700 space-y-1">
            <li>Ã¢â‚¬Â¢ Ensure good lighting for best results</li>
            <li>Ã¢â‚¬Â¢ Hold the document flat and straight</li>
            <li>Ã¢â‚¬Â¢ Position the entire document within the frame</li>
            <li>Ã¢â‚¬Â¢ Avoid shadows and glare on the document</li>
            <li>Ã¢â‚¬Â¢ Use a contrasting background (e.g., dark document on light surface)</li>
            <li>ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ Ensure good lighting for best results</li>
            <li>ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ Hold the document flat and straight</li>
            <li>ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ Position the entire document within the frame</li>
            <li>ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ Avoid shadows and glare on the document</li>
            <li>ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ Use a contrasting background (e.g., dark document on light surface)</li>
          </ul>
        </div>
      </div>
    </div>
