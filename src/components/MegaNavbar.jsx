  ...
  const megaMenus = {
    financial: {
      ...
      links: [
        ...
        { to: '/mexico-finance', label: 'Mexico Finance', icon: 'ÃƒÂ°Ã…Â¸Ã¢â‚¬Â¡Ã‚Â²ÃƒÂ°Ã…Â¸Ã¢â‚¬Â¡Ã‚Â½' },
      ]
    },
    realEstate: {
      label: 'Real Estate',
      ...
      links: [
        ...
        { to: '/us-mortgage', label: 'US Mortgage', icon: 'ÃƒÂ°Ã…Â¸Ã¢â‚¬Â¡Ã‚ÂºÃƒÂ°Ã…Â¸Ã¢â‚¬Â¡Ã‚Â¸' },
        ...
        <div className='max-w-[1920px] mx-auto'>
          <div className='border-b border-gray-200 px-6 py-2 flex items-center justify-between text-sm bg-green-50/50'>
            <div className='flex items-center gap-4'>
              <span className='text-gray-600 font-medium'>ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â AuditDNA Supreme</span>
              <span className='text-green-600 font-semibold'>ÃƒÂ¢Ã…â€œÃ¢â‚¬Å“ All Systems Operational</span>
            </div>
            <div className='text-gray-600'>
              ÃƒÂ°Ã…Â¸Ã…â€™Ã‚Â Multi-Region | ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã…Â¾ 24/7 Support
            </div>
          </div>
