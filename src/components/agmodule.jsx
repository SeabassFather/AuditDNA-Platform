...
export default function AgModule() {
  ...
  return (
    <div className="p-4">
      <h2 className="h2">Ã°Å¸Å’Â¾ Agriculture Module</h2>
      <div className="grid">
        <div className="card">
          <div className="card-title">Ã°Å¸â€™Â§ Water Management</div>
          <p className="subtext">
        ...
        <div className="card">
          <div className="card-title">Ã°Å¸â€™Âµ Factoring</div>
          <p className="subtext">
        ...
        <div className="card">
          <div className="card-title">Ã°Å¸â€œË† Produce Market Search</div>
          <input
            type="text"
            className="filter"
