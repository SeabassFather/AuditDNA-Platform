...
export const waterCategories = [
  { id: 'drinking', name: 'Drinking Water', nameEs: 'Agua Potable', icon: 'ðŸš°', testCount: 15, color: '#06b6d4' },
  { id: 'wastewater', name: 'Wastewater', nameEs: 'Aguas Residuales', icon: 'ðŸ­', testCount: 12, color: '#0891b2' },
  { id: 'surface', name: 'Surface Water', nameEs: 'Agua Superficial', icon: 'ðŸŒŠ', testCount: 10, color: '#0e7490' },
  { id: 'groundwater', name: 'Groundwater', nameEs: 'Agua SubterrÃ¡nea', icon: 'â›²', testCount: 13, color: '#155e75' }
];
