...
const AUDIT_CATEGORIES = {
  ...
  "Agriculture & Trade": {
    ...
    services: [
      ...
      {
        id: "AGR002",
        name: "Mexico Grower Ã¢â€ â€™ U.S. Buyer Matching",
        name: "Mexico Grower ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ U.S. Buyer Matching",
        price: "$499/match",
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between text-xs text-gray-500">
        <span>Ã¢ÂÂ±Ã¯Â¸Â {service.timeframe}</span>
        <span className="text-blue-600 font-semibold group-hover:underline">Request Audit Ã¢â€ â€™</span>
        <span>ÃƒÆ’Ã‚Â¢Ãƒâ€šÃ‚ÂÃƒâ€šÃ‚Â±ÃƒÆ’Ã‚Â¯Ãƒâ€šÃ‚Â¸Ãƒâ€šÃ‚Â {service.timeframe}</span>
        <span className="text-blue-600 font-semibold group-hover:underline">Request Audit ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢</span>
      </div>
    </div>
  );
}
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <div className="mt-6 flex justify-center gap-8 text-sm">
            ...
            <div className="flex items-center gap-2">
              <span className="text-2xl">Ã¢Å¡Â¡</span>
              <span className="text-2xl">ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã¢â‚¬Å“ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦</span>
              <span className="font-semibold">90%+ Success Rate</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-2xl">ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢Ãƒâ€šÃ‚Â°</span>
              <span className="font-semibold">$2.5K - $15K Avg Recovery</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-2xl">ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã‚Â¡Ãƒâ€šÃ‚Â¡</span>
