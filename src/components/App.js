  ...
  return (
    <div style={{ padding: '32px' }}>
      ...
      <div style={{ display: 'flex', gap: '16px', overflowX: 'auto', paddingBottom: '10px' }}>
        ...
        {tickers.mortgage.length > 0 && <LiveTicker data={tickers.mortgage} title="Mortgage" icon="ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€šÃ‚ÂÃƒâ€šÃ‚Â " />}
        {tickers.commodities.length > 0 && <LiveTicker data={tickers.commodities} title="Commodities" icon="ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â¾" />}
        {tickers.markets.length > 0 && <LiveTicker data={tickers.markets} title="Markets" icon="ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€¹Ã¢â‚¬Â " />}
      </div>
    </div>
  );
}
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '24px' }}>
          ...
          <button onClick={onClose} style={{ background: 'none', border: 'none', fontSize: '24px', cursor: 'pointer' }}>ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â</button>
        </div>
        ...
        {success ? (
          <div style={{ textAlign: 'center', padding: '40px', background: '#f0fdf4', borderRadius: '12px' }}>
            ...
            <div style={{ fontSize: '48px', marginBottom: '16px' }}>ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã¢â‚¬Å“ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦</div>
  ...
  const categories = [
    {
      ...
      name: 'USDA Pricing & Compliance', icon: 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â¾', color: '#10b981',
    ...
    },
    {
      ...
      name: 'WaterTech & Soil Analysis', icon: 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢Ãƒâ€šÃ‚Â§', color: '#06b6d4',
    ...
    },
    {
      ...
      name: 'Mortgage & Real Estate', icon: 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€šÃ‚ÂÃƒâ€šÃ‚Â ', color: '#667eea',
    ...
    },
    {
      ...
      name: 'Factoring & PO Finance', icon: 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢Ãƒâ€šÃ‚Â°', color: '#f59e0b',
    ...
    },
    {
      ...
      name: 'Insurance & Risk', icon: 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂºÃƒâ€šÃ‚Â¡ÃƒÆ’Ã‚Â¯Ãƒâ€šÃ‚Â¸Ãƒâ€šÃ‚Â', color: '#14b8a6',
    ...
    },
    {
      ...
      name: 'Global Compliance', icon: 'ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã‚Â¡ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ÃƒÆ’Ã‚Â¯Ãƒâ€šÃ‚Â¸Ãƒâ€šÃ‚Â', color: '#8b5cf6',
    ...
    },
    {
      ...
      name: 'Education & Records', icon: 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã‚Â½ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ', color: '#6366f1',
      services: ['FERPA Compliance', 'Transcript Validation', 'Scholarship Verification', 'Credit Transfer']
    },
    {
      name: 'Healthcare', icon: 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€šÃ‚ÂÃƒâ€šÃ‚Â¥', color: '#ec4899',
      services: ['HIPAA Audit', 'Medical Billing', 'Insurance Claims', 'Provider Credentialing']
    },
    {
      name: 'Business', icon: 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€šÃ‚ÂÃƒâ€šÃ‚Â¢', color: '#f43f5e',
      services: ['Tax Audit', 'Corporate Review', 'Lease Audit', 'Franchise Analysis']
    },
    {
      name: 'Consumer Protection', icon: 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂºÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢', color: '#84cc16',
      ...
      {categories.map((cat, idx) => (
        <div key={idx} style={{ background: '#fff', border: '1px solid #e2e8f0', borderRadius: '12px', marginBottom: '12px', overflow: 'hidden' }}>
          <button onClick={() => setExpandedCategory(expandedCategory === idx ? null : idx)}
            ...
            <div style={{ fontSize: '20px', color: '#64748b', transform: expandedCategory === idx ? 'rotate(180deg)' : 'rotate(0)', transition: 'transform 0.3s' }}>ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“Ãƒâ€šÃ‚Â¼</div>
          </button>
...
function SearchEngines() {
  ...
  const engines = [
    ...
    { key: 'usda', label: 'USDA Pricing', labelEs: 'Precios USDA', icon: 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â¾' },
    { key: 'watertech', label: 'WaterTech', labelEs: 'Agua y Suelo', icon: 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢Ãƒâ€šÃ‚Â§' },
    { key: 'mortgage', label: 'Mortgage', labelEs: 'Hipotecaria', icon: 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€šÃ‚ÂÃƒâ€šÃ‚Â ' },
    { key: 'factoring', label: 'Factoring', labelEs: 'Factoraje', icon: 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢Ãƒâ€šÃ‚Â°' },
    { key: 'mexico', label: 'Mexico RE', labelEs: 'Bienes RaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­ces', icon: 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¡Ãƒâ€šÃ‚Â²ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¡Ãƒâ€šÃ‚Â½' },
    { key: 'compliance', label: 'Compliance', labelEs: 'Cumplimiento', icon: 'ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã‚Â¡ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ÃƒÆ’Ã‚Â¯Ãƒâ€šÃ‚Â¸Ãƒâ€šÃ‚Â' },
    { key: 'upload', label: 'Upload', labelEs: 'Subir', icon: 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€šÃ‚Â¤' }
  ];
...
function Sidebar({ sidebarOpen, activeTab, setActiveTab }) {
  const items = [
    ...
    { key: 'services', label: 'Services', icon: 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂºÃƒâ€šÃ‚Â¡ÃƒÆ’Ã‚Â¯Ãƒâ€šÃ‚Â¸Ãƒâ€šÃ‚Â' },
    { key: 'search', label: 'Search', icon: 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â' }
  ];
    ...
    <div style={{ background: 'linear-gradient(135deg, #f0f4f8, #e1e8ed)', minHeight: '100vh' }}>
      ...
      <div style={{ marginLeft: sidebarOpen ? '280px' : '0', transition: 'margin-left 0.3s' }}>
        <button onClick={() => setSidebarOpen(!sidebarOpen)}
          ...
          {sidebarOpen ? 'ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Ãƒâ€šÃ‚Â' : 'ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢'}
        </button>
