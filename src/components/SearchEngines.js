Ã¯Â»Â¿import React, { useState } from 'react';
...
export default function SearchEngines({ activeSearchEngine, setActiveSearchEngine }) {
  ...
  const engines = [
    ...
    { id: 'watertech', en: 'WaterTech', es: 'AnÃƒÂ¡lisis de Agua', icon: FileText, color: '#2196f3' },
    { id: 'mortgage', en: 'Mortgage', es: 'Hipotecas', icon: Home, color: '#ff9800' },
    { id: 'factoring', en: 'Ag Factoring', es: 'Factoraje AgrÃƒÂ­cola', icon: DollarSign, color: '#9c27b0' },
    { id: 'mexico', en: 'Mexico RE', es: 'Bienes RaÃƒÂ­ces MX', icon: Briefcase, color: '#f44336' },
    { id: 'watertech', en: 'WaterTech', es: 'AnÃƒÆ’Ã‚Â¡lisis de Agua', icon: FileText, color: '#2196f3' },
    { id: 'mortgage', en: 'Mortgage', es: 'Hipotecas', icon: Home, color: '#ff9800' },
    { id: 'factoring', en: 'Ag Factoring', es: 'Factoraje AgrÃƒÆ’Ã‚Â­cola', icon: DollarSign, color: '#9c27b0' },
    { id: 'mexico', en: 'Mexico RE', es: 'Bienes RaÃƒÆ’Ã‚Â­ces MX', icon: Briefcase, color: '#f44336' },
      ...
      {activeSearchEngine === 'usda' && (
        <div style={s.card}>
          ...
          <button onClick={handleSearch} style={{ ...s.btn('#4caf50'), marginTop: '20px' }} disabled={loading}>
            {loading ? 'Ã¢ÂÂ³ Searching...' : <><SearchIcon size={20} />Search Prices</>}
            {loading ? 'ÃƒÂ¢Ã‚ÂÃ‚Â³ Searching...' : <><SearchIcon size={20} />Search Prices</>}
          </button>
