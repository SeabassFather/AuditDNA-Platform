      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <ul className="text-sm text-blue-700 space-y-1">
            <li>Ã¢â‚¬Â¢ Look directly at the camera</li>
            <li>Ã¢â‚¬Â¢ Ensure your face is well-lit and clearly visible</li>
            <li>Ã¢â‚¬Â¢ Remove sunglasses, hats, or masks</li>
            <li>Ã¢â‚¬Â¢ Position your face within the oval guide</li>
            <li>Ã¢â‚¬Â¢ Keep your expression neutral</li>
            <li>Ã¢â‚¬Â¢ Hold still during the countdown</li>
            <li>ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ Look directly at the camera</li>
            <li>ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ Ensure your face is well-lit and clearly visible</li>
            <li>ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ Remove sunglasses, hats, or masks</li>
            <li>ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ Position your face within the oval guide</li>
            <li>ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ Keep your expression neutral</li>
            <li>ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ Hold still during the countdown</li>
          </ul>
        </div>
      </div>
    </div>
