...
export default function FinancialServices() {
  ...
  const tabs = [
    { id: 'factoring', label: 'Invoice Factoring', icon: 'ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Âµ' },
    { id: 'payment-terms', label: 'Payment Terms', icon: 'ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã¢â‚¬Â¦' },
    { id: 'credit-risk', label: 'Credit Risk', icon: 'ÃƒÂ¢Ã…Â¡Ã‚Â ÃƒÂ¯Ã‚Â¸Ã‚Â' },
    { id: 'working-capital', label: 'Working Capital', icon: 'ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‹â€ ' },
    { id: 'currency', label: 'Currency Exchange', icon: 'ÃƒÂ°Ã…Â¸Ã…â€™Ã‚Â' },
    { id: 'reports', label: 'Financial Reports', icon: 'ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã…Â ' }
  ];
      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: '40px' }}>
          <h1 style={{ 
            ...
            ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Â° Financial Services
          </h1>
          <p style={{ 
            fontSize: '1.15rem', 
            color: '#475569', 
        ...
        <div style={{ background: '#f8fafc', padding: '24px', borderRadius: '12px', border: '2px solid #e2e8f0' }}>
          ...
          <div style={{ display: 'flex', gap: '12px', marginTop: '24px', paddingTop: '24px', borderTop: '2px solid #e2e8f0' }}>
            <button style={{ 
              ...
              ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã¢â‚¬Å¾ Generate PDF
            </button>
            <button style={{ 
              flex: 1,
              padding: '12px', 
              ...
              ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â§ Email Report
            </button>
            <button style={{ 
              flex: 1,
              padding: '12px', 
              ...
              ÃƒÂ°Ã…Â¸Ã¢â‚¬â€œÃ‚Â¨ÃƒÂ¯Ã‚Â¸Ã‚Â Print
            </button>
          </div>
        </div>
      )}
...
// =================================function PaymentTermsTab() {
  return (
    <div style={{ textAlign: 'center', padding: '60px 20px' }}>
      <div style={{ fontSize: '4rem', marginBottom: '24px' }}>ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã¢â‚¬Â¦</div>
...
// =================================function CreditRiskTab() {
  return (
    <div style={{ textAlign: 'center', padding: '60px 20px' }}>
      <div style={{ fontSize: '4rem', marginBottom: '24px' }}>ÃƒÂ¢Ã…Â¡Ã‚Â ÃƒÂ¯Ã‚Â¸Ã‚Â</div>
      <h2 style={{ fontSize: '2rem', fontWeight: '800', color: '#0f172a', marginBottom: '16px' }}>
...
// =================================function WorkingCapitalTab() {
  return (
    <div style={{ textAlign: 'center', padding: '60px 20px' }}>
      <div style={{ fontSize: '4rem', marginBottom: '24px' }}>ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‹â€ </div>
      <h2 style={{ fontSize: '2rem', fontWeight: '800', color: '#0f172a', marginBottom: '16px' }}>
...
// =================================function CurrencyTab() {
  return (
    <div style={{ textAlign: 'center', padding: '60px 20px' }}>
      <div style={{ fontSize: '4rem', marginBottom: '24px' }}>ÃƒÂ°Ã…Â¸Ã…â€™Ã‚Â</div>
      <h2 style={{ fontSize: '2rem', fontWeight: '800', color: '#0f172a', marginBottom: '16px' }}>
        Currency Exchange
      </h2>
      <p style={{ fontSize: '1.1rem', color: '#64748b', marginBottom: '32px' }}>
...
// =================================function ReportsTab() {
  const reports = [
    { name: 'Summary Report', icon: 'ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã…Â ', desc: 'Key financial metrics and KPIs', color: '#3b82f6' },
    { name: 'AR Aging Report', icon: 'ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã¢â‚¬Â¦', desc: 'Accounts receivable aging analysis', color: '#22c55e' },
    { name: 'Profitability Analysis', icon: 'ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Â°', desc: 'Product-level profit margins', color: '#8b5cf6' },
    { name: 'Cash Flow Statement', icon: 'ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Âµ', desc: 'Operating, investing, financing activities', color: '#eab308' }
  ];
