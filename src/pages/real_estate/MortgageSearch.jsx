const MortgageSearch = () => (
  <div style={pageWrap}>
    ...
    <p style={desc}>
      Submit criteria; real API required. Errors will be shown inline.
    </p>
    <div style={card}>
      ...
      >
        <div>
          ...
          <input style={input} />
          <label>
            <input type="checkbox" /> NMLS Consent
          </label>
          <label>
            <input type="checkbox" /> Soft-Pull Consent
          </label>
        </div>
        <div>
          <label>Address</label>
          ...
          <div>
            <label>
              <input type="radio" name="family" /> Owner
            </label>
            <label>
              <input type="radio" name="family" /> Second
            </label>
            <label>
              <input type="radio" name="family" /> Investment
            </label>
          </div>
          <label>
            <input type="radio" name="purpose" /> Purchase
          </label>
          <label>
            <input type="radio" name="purpose" /> Refi
          </label>
