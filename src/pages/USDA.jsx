  ...
  const fetchAvailableCommodities = async () => {
    ...
    try {
      setCommodities([
        ...
        'PEPPERS', 'BELL PEPPERS', 'JALAPEÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‹Å“OS', 'HABANEROS',
  ...
  return (
    <div className="max-w-[95%] mx-auto p-6 space-y-6">
      <div className="bg-gradient-to-r from-green-600 to-green-700 text-white rounded-lg shadow-lg p-6">
        ...
        <h1 className="text-3xl font-bold mb-2">ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â½ USDA Pricing Comparison & Analytics</h1>
        <p className="text-green-100">100+ Products ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ Regional Pricing ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ Market Analytics</p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-lg p-2 flex gap-2">
        ...
        >
          ...
          ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢Ãƒâ€šÃ‚Â° Pricing vs Cost Comparison
        </button>
        <button
        ...
        >
          ...
          ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€¦Ã‚Â  Market Analytics
        </button>
      </div>
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-center gap-2 text-sm flex-wrap">
                ...
                <span className="text-gray-400">Ã¢â‚¬Â¢</span>
                <span className="text-gray-400">ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢</span>
                <span className="text-blue-900">{selectedSize}</span>
                <span className="text-gray-400">ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢</span>
                <span className="text-blue-900 font-semibold">{selectedPackaging}</span>
                <span className="text-gray-400">ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢</span>
          ...
          <div className="grid grid-cols-3 gap-6">
            <div className="bg-blue-50 rounded-lg shadow-lg p-6 border-l-4 border-blue-500">
              ...
              <h3 className="text-lg font-bold text-blue-900 mb-4">ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€¦Ã‚Â  West Coast</h3>
            ...
            <div className="bg-orange-50 rounded-lg shadow-lg p-6 border-l-4 border-orange-500">
              ...
              <h3 className="text-lg font-bold text-orange-900 mb-4">ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â¾ Midwest</h3>
              <div className="space-y-3">
                <div>
                  <div className="text-xs text-gray-600">Wholesale Price</div>
            ...
            <div className="bg-purple-50 rounded-lg shadow-lg p-6 border-l-4 border-purple-500">
              ...
              <h3 className="text-lg font-bold text-purple-900 mb-4">ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€šÃ‚ÂÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ÃƒÆ’Ã‚Â¯Ãƒâ€šÃ‚Â¸Ãƒâ€šÃ‚Â East Coast</h3>
              <div className="space-y-3">
                <div>
                  <div className="text-xs text-gray-600">Wholesale Price</div>
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              {commodities.slice(0, 30).map(commodity => (
                ...
                >
                  ...
                  {commodity} {selectedCommodities.includes(commodity) && 'ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã¢â‚¬Å“ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ'}
                </button>
              ))}
            </div>
