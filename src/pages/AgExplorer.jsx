            ...
            <div className="card-grid" style={{ marginTop: 12 }}>
              {hints.map((h) => (
                <div className="card" key={h}>
                  ...
                  <div className="subtext">connect USDA endpoint to show live data</div>
                </div>
              ))}
            </div>
          )}
      ...
      {tab === "factoring" && (
        <div className="grid">
          <div className="card">
            ...
            <div className="subtext">Advance: {advance ? "$" + advance.toLocaleString() : ""} | Fee: {fee ? "$" + fee.toLocaleString() : ""} | Net: {net ? "$" + net.toLocaleString() : ""}</div>
          </div>
        </div>
      )}
