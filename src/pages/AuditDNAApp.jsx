...
function AgCommoditiesTicker() {
  ...
  return <PremiumTicker data={commodities} title="Ag Commodities" icon="ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â¾" color="#4a96ff" />;
}
...
function EquitiesTicker() {
  ...
  return <PremiumTicker data={markets} title="Markets" icon="ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€¹Ã¢â‚¬Â " color="#ff6b35" />;
}
