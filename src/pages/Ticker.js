        ...
        {data.map((item, i) => (
          <div key={i} style={{
            ...
            <span style={{
              ...
              {item.change >= 0 ? 'Ã¢â€“Â²' : 'Ã¢â€“Â¼'} {Math.abs(item.change).toFixed(2)}
              {item.change >= 0 ? 'ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“Ãƒâ€šÃ‚Â²' : 'ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“Ãƒâ€šÃ‚Â¼'} {Math.abs(item.change).toFixed(2)}
            </span>
          </div>
        ))}
      </div>
