...
export default function MexicoLoans() {
  ...
  const mexicoLenders = [
    {
      ...
      regions: ['CDMX', 'Cancun', 'Tulum', 'Los Cabos', 'Puerto Vallarta', 'Guadalajara', 'Playa del Carmen', 'Monterrey', 'MazatlÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡n', 'La Paz', 'Sayulita', 'Punta Mita', 'Riviera Nayarit', 'Cozumel', 'Akumal'],
      minAmount: 50000,
      maxAmount: 5000000,
      baseRate: 7.50,
    ...
    },
    {
      ...
      regions: ['Los Cabos', 'Puerto Vallarta', 'MazatlÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡n', 'La Paz'],
      minAmount: 50000,
      maxAmount: 1000000,
      baseRate: 9.125,
      foreignNational: true,
  ...
  const calculateRates = () => {
    ...
    if (!amount || amount < 50000) {
      ...
      alert('Por favor ingrese un monto vÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡lido (mÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­nimo $50,000 USD)');
      return;
    }
    
    if (!propertyRegion) {
      alert('Por favor seleccione una regiÃƒÂ³n');
      alert('Por favor seleccione una regiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n');
      return;
    }
    ...
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 rounded-lg shadow-2xl p-8 text-white">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <h1 className="text-4xl font-bold">PrÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©stamos Hipotecarios en MÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©xico</h1>
      ...
      <div className="bg-white rounded-lg shadow-lg p-8">
        <h2 className="text-2xl font-bold mb-6 flex items-center gap-3">
          ...
          Search Criteria / Criterios de BÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Âºsqueda
        </h2>
        
        <div className="grid grid-cols-2 gap-6 mb-6">
          <div>
            <label className="block font-bold mb-2">Loan Purpose / PropÃƒÂ³sito</label>
            <label className="block font-bold mb-2">Loan Purpose / PropÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³sito</label>
            <select 
              value={loanType}
          ...
          <div>
            ...
            <label className="block font-bold mb-2">Property Region / RegiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n</label>
            <select 
            ...
            >
              ...
              <option value="CDMX">Ciudad de MÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©xico (CDMX)</option>
              <option value="Cancun">CancÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Âºn, Quintana Roo</option>
              ...
              <option value="Monterrey">Monterrey, Nuevo LeÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n</option>
              <option value="MazatlÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡n">MazatlÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡n, Sinaloa</option>
          ...
          <div>
            ...
            <label className="block font-bold mb-2">Citizenship / CiudadanÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­a</label>
            <select 
              value={citizenship}
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="flex items-center gap-3 mb-6 p-4 bg-blue-50 border-2 border-blue-200 rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm text-gray-700 mt-1">
                ...
                Las tasas estimadas son aproximadas. Las tasas finales requieren solicitud completa, avalÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Âºo de propiedad, configuraciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n de fideicomiso y aprobaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n de suscripciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n.
              </p>
            </div>
          </div>
            ...
            {results.map((result, index) => (
              <div key={result.id} className="border-2 border-gray-200 rounded-lg p-6 hover:border-blue-400 transition-all">
                ...
                <div className="pt-4 border-t border-gray-200">
                  ...
                  <p className="text-xs text-gray-500">*Basado en plazo de 20 aÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â±os. Solo capital e interÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©s. No incluye impuestos prediales, seguro o cuotas de fideicomiso.</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="mt-6 bg-yellow-50 border-2 border-yellow-300 rounded-lg p-6">
            <h4 className="font-bold text-gray-800 mb-3 flex items-center gap-2">
              ...
              Required Documentation / DocumentaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n Requerida:
            </h4>
            <ul className="space-y-2 text-sm text-gray-700">
              ...
              <li className="flex items-start gap-2">
                ...
                Valid passport and proof of legal status in Mexico / Pasaporte vÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡lido y comprobante de estatus legal
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                Proof of income (2 years tax returns, bank statements) / Comprobante de ingresos (2 aÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â±os de declaraciones, estados de cuenta)
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                Property appraisal by approved Mexican appraiser / AvalÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Âºo por tasador mexicano aprobado
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                Fideicomiso (bank trust) setup for foreign buyers / ConfiguraciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n de fideicomiso para compradores extranjeros
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                Credit report from home country / Reporte de crÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©dito del paÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­s de origen
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                Down payment typically 30-50% for foreign nationals / Enganche tÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­picamente 30-50% para extranjeros
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg shadow-lg p-8 border-2 border-gray-300">
        ...
        <div className="mt-6 pt-6 border-t-2 border-gray-300 space-y-3 text-sm text-gray-600">
          ...
          <p className="font-semibold mt-4">FINANCIAMIENTO DE PROPIEDAD EN MÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â°XICO:</p>
          <p>
            Intermediamos prÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©stamos de propiedades en MÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©xico a travÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©s de nuestra red de prestamistas aprobados. Todos los prÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©stamos estÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡n sujetos a regulaciones bancarias mexicanas y requieren el establecimiento de un fideicomiso para propiedades dentro de la zona restringida.
          </p>
          ...
          <p className="text-xs text-gray-500 mt-4 text-center">
            ...
            ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â© {new Date().getFullYear()} Everwise Home Loans & Realty. All Rights Reserved. | Todos los Derechos Reservados.
          </p>
        </div>
      </div>
    </div>
