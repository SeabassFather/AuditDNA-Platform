    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        <div className="bg-gradient-to-r from-green-600 to-green-700 text-white p-8 rounded-xl shadow-lg">
          ...
          <h1 className="text-4xl font-bold mb-2">ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â½ USDA Verified Marketplace</h1>
          <p className="text-green-100 mb-4">Real-time certificate verification ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ Document management ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ Compliance tracking</p>
          <button
  ...
  const handleSearch = () => {
    ...
    setTimeout(() => {
      setSearchResults({
        ...
        address: 'MichoacÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡n, Mexico',
          ...
          {searchResults.found ? (
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-2xl font-bold text-green-800">Certificate Verified ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã¢â‚¬Å“ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ</h3>
              </div>
                  ...
                  <div key={cert.key} className="border-2 border-gray-200 rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                      ...
                      <div>
                        ...
                        {certifications[cert.key].file && <p className="text-xs text-gray-600 mt-1">ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã¢â‚¬Å“ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ {certifications[cert.key].file.name}</p>}
                      </div>
