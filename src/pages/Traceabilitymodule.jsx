  ...
  deficiencies: [
    {
      ...
      human_health: {
        ...
        negative: ['Excess nitrates ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ methemoglobinemia (blue baby syndrome)', 'Carcinogenic nitrosamine formation']
      },
    ...
    },
    {
      ...
      human_health: {
        ...
        negative: ['Excess in water ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ eutrophication', 'Algal blooms']
      },
    ...
    },
    {
      ...
      human_health: {
        ...
        negative: ['Deficiency ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ muscle weakness, cardiac arrhythmia']
      },
    ...
    },
    {
      ...
      human_health: {
        ...
        negative: ['Excess ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ liver damage (hemochromatosis)', 'Oxidative stress']
      },
    ...
    },
    {
      ...
      human_health: {
        ...
        negative: ['Deficiency ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ growth retardation, immune dysfunction']
      },
    ...
    },
    {
      ...
      human_health: {
        ...
        negative: ['Deficiency ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ osteoporosis, rickets']
      },
...
// IoT Sensors
const IOT_SENSORS = [
  { id: 1, name: 'pH Sensor', range: '0-14 pH', accuracy: 'ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â±0.1 pH', connectivity: 'WiFi/LoRa', price: '$150-$400', alerts: 'Real-time threshold alerts' },
  { id: 2, name: 'Dissolved Oxygen', range: '0-20 mg/L', accuracy: 'ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â±0.2 mg/L', connectivity: 'WiFi/LoRa', price: '$300-$800', alerts: 'Low oxygen warnings' },
  { id: 3, name: 'EC/TDS Meter', range: '0-10,000 ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚ÂµS/cm', accuracy: 'ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â±2%', connectivity: 'WiFi/LoRa', price: '$200-$500', alerts: 'Salinity alerts' },
  { id: 4, name: 'Nitrate Sensor', range: '0-100 ppm', accuracy: 'ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â±5%', connectivity: 'WiFi/LoRa', price: '$400-$1,200', alerts: 'Contamination alerts' },
  { id: 5, name: 'Soil Moisture', range: '0-100%', accuracy: 'ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â±3%', connectivity: 'WiFi/LoRa', price: '$100-$300', alerts: 'Irrigation triggers' },
  { id: 6, name: 'Temperature Probe', range: '-40 to 125ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â°C', accuracy: 'ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â±0.5ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â°C', connectivity: 'WiFi/LoRa', price: '$80-$200', alerts: 'Freeze/heat warnings' }
];
    ...
    <div className="space-y-6">
      ...
      <div className="border-2 border-dashed border-cyan-400/50 rounded-lg p-8 text-center hover:border-cyan-400 transition">
        ...
        <label htmlFor="file-upload" className="cursor-pointer">
          ...
          <div className="text-sm text-gray-400">PDF, CSV, or Excel ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ Water or Soil Tests</div>
        </label>
      </div>
        ...
        <div className="bg-white/10 rounded-lg p-6 space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-sm text-gray-400">{results.sampleType} ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ {results.uploadDate}</div>
            </div>
    ...
    <div className="bg-white/5 rounded-lg p-4 border border-white/10">
      ...
      {expanded && (
        <div className="mt-4 space-y-3 text-sm">
          {db.health_impact && (
            <div>
              <div className="font-semibold text-red-400 mb-1">ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã‚Â¡Ãƒâ€šÃ‚Â ÃƒÆ’Ã‚Â¯Ãƒâ€šÃ‚Â¸Ãƒâ€šÃ‚Â Health Impacts:</div>
          ...
          {db.sources && (
            <div>
              <div className="font-semibold text-yellow-400 mb-1">ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€šÃ‚Â Sources:</div>
          ...
          {db.treatment && (
            <div>
              <div className="font-semibold text-green-400 mb-1">ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢Ãƒâ€¦Ã‚Â  Treatment:</div>
          ...
          {db.bioaccumulation && (
            <div>
              <div className="font-semibold text-purple-400 mb-1">ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€šÃ‚Â§Ãƒâ€šÃ‚Â¬ Bioaccumulation:</div>
          ...
          {db.food_impact && (
            <div>
              <div className="font-semibold text-blue-400 mb-1">ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€šÃ‚ÂÃƒâ€¦Ã‚Â½ Food Impact:</div>
