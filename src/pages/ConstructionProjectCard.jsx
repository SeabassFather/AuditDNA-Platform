...
const text = {
  ...
  spanish: {
    ...
    title: "Financiamiento de Proyecto de ConstrucciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n (Ciudadanos EE.UU.)",
    subtitle: "Financie su proyecto de construcciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n en MÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©xico (Colateral en EE.UU. aceptado)",
    fullName: "Nombre Completo",
    email: "Correo ElectrÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³nico",
    phone: "NÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Âºmero de TelÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©fono",
    projectAddress: "DirecciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n del Proyecto en MÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©xico",
    projectType: "Tipo de Proyecto",
    projectCost: "Costo Estimado del Proyecto (USD)",
    landOwned: "ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿Es dueÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â±o del terreno?",
    ...
    submit: "Enviar Proyecto para RevisiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n",
    thankyou: "ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡Gracias! Nuestro equipo de financiamiento se comunicarÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡."
  }
};
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          <div>
            ...
            >
              ...
              <option value="yes">{language === "english" ? "Yes" : "SÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­"}</option>
