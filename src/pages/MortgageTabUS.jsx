...
// import your lenders.json if you want real matching
...
export default function MortgageTabUS() {
  ...
  // TODO: Replace this with your real lenders data & sophisticated matching logic
  const lenders = [
  ...
  return (
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-green-600 via-teal-600 to-blue-600 rounded-lg shadow-2xl p-8 text-white">
        ...
        <p className="text-xl">Real-Time Lender Matching Ã¢â‚¬Â¢ Professional Service</p>
        <p className="text-xl">Real-Time Lender Matching ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ Professional Service</p>
      </div>
