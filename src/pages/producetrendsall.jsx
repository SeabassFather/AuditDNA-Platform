...
export default function ProduceTrendsAll({ areaTitle = "USDA Ag Produce" }) {
  const [search, setSearch] = useState("");
  const [selected, setSelected] = useState(ALL_COMMODITIES.slice(0, 2));
  ...
  return (
    ...
    >
      ...
      <div style={{ marginTop: 20 }}>
        {loading ? (
          <div
            style={{ textAlign: "center", color: "#cb356b", margin: "20px 0" }}
          >
            Loading price data...
          </div>
        ) : error ? (
          <div
            style={{ textAlign: "center", color: "#c62828", margin: "20px 0" }}
          >
            {error}
          </div>
          ...
          <div
            style={{ textAlign: "center", color: "#a1a1aa", margin: "30px 0" }}
          >
