    ...
    >
      ...
      >
        ...
        <nav style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
          ...
          <NavLink to="/mortgage" style={linkStyle}>
            Mortgage
          </NavLink>
          <NavLink to="/trade-finance" style={linkStyle}>
            Trade Finance
          </NavLink>
          <NavLink to="/ag-market" style={linkStyle}>
            Ag Marketplace
          </NavLink>
          <NavLink to="/tickers" style={linkStyle}>
            Tickers
          </NavLink>
          <NavLink to="/agreements" style={linkStyle}>
            Agreements
          </NavLink>
