      ...
      <div className="bg-gradient-to-r from-green-600 to-green-700 text-white py-8 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-4xl font-bold mb-2">Ã°Å¸Å’Â¾ USDA Grower Search Engine</h1>
              <h1 className="text-4xl font-bold mb-2">ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â¾ USDA Grower Search Engine</h1>
        ...
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-2">
              ...
              {grower.organic && <span className="text-xs bg-green-100 text-green-800 px-2 py-1 rounded">Ã°Å¸Å’Â¿ Organic</span>}
              {grower.organic && <span className="text-xs bg-green-100 text-green-800 px-2 py-1 rounded">ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â¿ Organic</span>}
    ...
    <div className="bg-white rounded-xl border border-gray-200 hover:shadow-xl transition overflow-hidden">
      <div className="bg-gradient-to-r from-green-500 to-green-600 px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          {grower.organic && <span className="text-xs bg-white text-green-700 px-2 py-1 rounded">Ã°Å¸Å’Â¿</span>}
          {grower.organic && <span className="text-xs bg-white text-green-700 px-2 py-1 rounded">ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã¢â‚¬â„¢Ãƒâ€šÃ‚Â¿</span>}
        </div>
      </div>
