...
const VERIFICATION_SYSTEMS = {
  ...
  senasica: {
    ...
    icon: 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¡Ãƒâ€šÃ‚Â²ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¡Ãƒâ€šÃ‚Â½',
    color: 'red',
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto space-y-6">
        <div className="bg-green-600 text-white p-8 rounded-xl">
          ...
          <h1 className="text-4xl font-bold mb-2">ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â Real-Time Certification Verification</h1>
          <p className="text-green-100">5 databases ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ 733,000+ records ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ Full intel & sharing</p>
        </div>
              ...
              {searchResults.found ? (
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <h3 className="text-2xl font-bold text-green-800">ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã¢â‚¬Å“ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ VERIFIED & CERTIFIED</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <div className="text-xs text-gray-500 mt-2">
                          ...
                          ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€šÃ‚Â Coordinates: {searchResults.latitude}, {searchResults.longitude}
                        </div>
                      </div>
                      <div>
                    ...
                    <div className="mt-4 bg-gray-100 rounded-lg overflow-hidden border-2 border-gray-300">
                      ...
                      <div className="bg-blue-600 text-white p-3 flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-bold">ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€šÃ‚Â Verified Location: {searchResults.city}, {searchResults.state}</span>
                        </div>
                        <a
                  ...
                  <div className="bg-gradient-to-br from-yellow-50 to-orange-50 p-6 rounded-lg border-4 border-orange-400">
                    ...
                    <p className="text-sm text-orange-800 font-semibold mb-4">
                      Ã¢Å¡Â¡ Direct contacts to purchasing team - bypass gatekeepers!
                        <span className="text-3xl">ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢Ãƒâ€šÃ‚Â°</span>
                        <span className="text-orange-800">BUYER/PROCUREMENT CONTACTS</span>
                      </h4>
                      <div className="bg-orange-600 text-white px-4 py-2 rounded-lg font-bold text-sm">
                        ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã‚Â½Ãƒâ€šÃ‚Â¯ DECISION MAKERS
                      </div>
                    </div>
                    <p className="text-sm text-orange-800 font-semibold mb-4">
                      ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã‚Â¡Ãƒâ€šÃ‚Â¡ Direct contacts to purchasing team - bypass gatekeepers!
                    </p>
                        ...
                        <div key={idx} className="bg-white p-5 rounded-lg border-2 border-orange-200 hover:border-orange-400 transition-all shadow-md">
                          ...
                          <div className="mt-3 flex gap-2">
                            ...
                            <a href={`https://${buyer.linkedIn}`} target="_blank" rel="noopener noreferrer" className="flex-1 bg-purple-600 hover:bg-purple-700 text-white py-2 rounded font-bold text-center text-sm">
                              Ã°Å¸â€™Â¼ LinkedIn
                              ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€šÃ‚Â§ Email Now
                            </a>
                            <a href={`tel:${buyer.directPhone}`} className="flex-1 bg-green-600 hover:bg-green-700 text-white py-2 rounded font-bold text-center text-sm">
                              ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€¦Ã‚Â¾ Call Now
                            </a>
                            <a href={`https://${buyer.linkedIn}`} target="_blank" rel="noopener noreferrer" className="flex-1 bg-purple-600 hover:bg-purple-700 text-white py-2 rounded font-bold text-center text-sm">
                              ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢Ãƒâ€šÃ‚Â¼ LinkedIn
                            </a>
                          </div>
                        </div>
                      ))}
                    ...
                    <div className="mt-4 bg-orange-600 text-white p-4 rounded-lg">
                      ...
                      <p className="font-bold mb-2">ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢Ãƒâ€šÃ‚Â¡ PRO TIP:</p>
                  ...
                  <div className="bg-gradient-to-br from-cyan-50 to-blue-50 p-6 rounded-lg border-4 border-cyan-400">
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="font-bold text-xl flex items-center gap-2">
                        <span className="text-3xl">Ã°Å¸â€â€”</span>
                        <span className="text-3xl">ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â</span>
                    ...
                    <p className="text-sm text-cyan-800 font-semibold mb-4">
                      ...
                      ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã‚Â¡Ãƒâ€šÃ‚Â¡ Similar suppliers in the same area - expand your options!
                    </p>
                        ...
                        <div key={idx} className="bg-white p-4 rounded-lg border-2 border-cyan-200 hover:border-cyan-400 hover:shadow-lg transition-all">
                          <div className="flex items-start justify-between mb-2">
                            <div className="flex-1">
                              ...
                              <div className="text-xs text-gray-600 mb-1">ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€šÃ‚Â {lead.distance}</div>
                              ...
                              <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className="text-xs bg-orange-100 text-orange-700 px-2 py-1 rounded font-semibold">
                                  ...
                                  ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã¢â‚¬Å“ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ {lead.matchReason}
                                </span>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="bg-cyan-50 p-3 rounded-lg mb-2">
                            ...
                            <div className="text-xs text-gray-600 mb-1">ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢Ãƒâ€šÃ‚Â¼ Buyer Contact</div>
                            <div className="font-bold text-sm text-gray-900 mb-1">{lead.buyerContact}</div>
                            <div className="grid grid-cols-2 gap-2 text-xs">
                              <a href={`mailto:${lead.buyerEmail}`} className="text-blue-700 hover:underline font-semibold truncate">
                                ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€šÃ‚Â§ {lead.buyerEmail}
                              </a>
                              <a href={`tel:${lead.buyerPhone}`} className="text-green-700 hover:underline font-semibold">
                                ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€¦Ã‚Â¾ {lead.buyerPhone}
                              </a>
                            </div>
                          </div>
                          ...
                          <div className="flex gap-2">
                            ...
                            >
                              ...
                              ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â View Full Details
                            </button>
                            <a 
                            ...
                            >
                              ...
                              ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€šÃ‚Â§ Contact Now
                            </a>
                          </div>
                        </div>
                      ))}
                    ...
                    <div className="mt-4 bg-cyan-600 text-white p-4 rounded-lg">
                      ...
                      <p className="font-bold mb-2">ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢Ãƒâ€šÃ‚Â¡ WHY CROSS-REFERENCE?</p>
                      <ul className="text-sm space-y-1 list-disc list-inside">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-red-600 mt-2">ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã‚Â¡Ãƒâ€šÃ‚Â ÃƒÆ’Ã‚Â¯Ãƒâ€šÃ‚Â¸Ãƒâ€šÃ‚Â DO NOT PROCEED - Supplier cannot be verified as legal</p>
                  </div>
                </div>
              )}
            </div>
