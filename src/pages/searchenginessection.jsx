...
const ENGINES = [
  {
    ...
    color: "#4285F4",
    icon: "Ã°Å¸â€Å½",
    icon: "ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€¦Ã‚Â½",
  },
  {
    name: "Bing",
...
export default function SearchEnginesSection() {
  ...
  return (
    <div style={{ padding: "1.2rem 0" }}>
      <h2 style={{ fontSize: "1.25rem", fontWeight: 700, marginBottom: 14 }}>
        Mortgage & Factoring Search Engines
      </h2>
        ...
        {ENGINES.map((engine) => (
          ...
          >
            ...
            {engine.name !== "USDA" ? (
              ...
              <>
                <div
                  style={{ fontSize: ".97rem", color: "#222", marginBottom: 7 }}
                >
      ...
      <div style={{ marginTop: 13, fontSize: ".93rem", color: "#888" }}>
        ...
        {DEFAULT_QUERIES.map((q) => (
          <span key={q} style={{ marginRight: 9 }}>
            <code>{q}</code>
          </span>
        ))}
      </div>
