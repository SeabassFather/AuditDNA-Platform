    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50 py-8 px-4">
      <div className="max-w-7xl mx-auto">
                  ...
                  <div key={listing.listingId} className="border-2 border-gray-200 rounded-xl p-6 hover:shadow-lg transition-all">
                    <div className="flex justify-between items-start mb-4">
                      <div className="flex-1">
                        ...
                        <p className="text-gray-600 mb-3">{listing.region} Ã¢â‚¬Â¢ {listing.propertyType}</p>
                    ...
                    <div className="flex gap-3 pt-4 border-t border-gray-200">
                      {listing.status === 'pending_agreement' && <span className="text-sm text-gray-600 italic">Ã¢Å¡Â Ã¯Â¸Â Waiting for commission agreement signature</span>}
                      {listing.status === 'pending_approval' && <span className="text-sm text-gray-600 italic">Ã¢ÂÂ³ Your listing is under admin review</span>}
        ...
        <div className="mt-8 bg-gradient-to-r from-purple-100 to-pink-100 rounded-xl p-6 border-2 border-purple-300">
          <h3 className="text-lg font-bold text-gray-900 mb-2">Ã°Å¸â€œÅ  Commission Structure</h3>
