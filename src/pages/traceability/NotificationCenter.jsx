      ...
      <div className="notification-panel" onClick={e => e.stopPropagation()}>
        ...
        <div className="notification-header">
          <div className="notification-title">
            ...
            <h2>ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Notifications</h2>
            {unreadCount > 0 && (
        ...
        <div className="notifications-container">
          {filteredNotifications.length === 0 ? (
            <div className="no-notifications">
              ...
              <div className="no-notifications-icon">ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢</div>
                ...
                <div className="notification-body">
                  ...
                  {notification.action && (
                    ...
                    >
                      ...
                      {notification.action.label} ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢
                    </a>
                  )}
                </div>
