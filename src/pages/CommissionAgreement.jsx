...
const CommissionAgreement = ({ onAgree, propertyData, agentData }) => {
  ...
  const agreementText = {
    ...
    spanish: {
      ...
      title: "ACUERDO EXCLUSIVO DE LISTADO Y COMISIÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œN",
      subtitle: "AuditDNA Elite - Plataforma de Bienes RaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­ces en MÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©xico",
      recitals: "Este Acuerdo se celebra entre el Agente de Bienes RaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­ces firmante (\"Agente\") y la Plataforma AuditDNA Elite (\"Plataforma\"), operada por Everwise Home Loans & Realty.",
      terms: [
        { heading: "1. ESTRUCTURA DE COMISIÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œN", content: "El Agente acepta una divisiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n de comisiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n 50/50 en todas las transacciones originadas a travÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©s de esta Plataforma. La comisiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n total se dividirÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡ equitativamente entre el Agente y la Plataforma al cierre exitoso de cualquier propiedad listada aquÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­." },
        { heading: "2. SERVICIOS DE LA PLATAFORMA", content: "La Plataforma se compromete a proporcionar: (a) Visibilidad del listado de propiedades en mercados de MÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©xico y EE.UU., (b) Servicios de marketing y promociÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n, (c) CoordinaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n de financiamiento a travÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©s de servicios hipotecarios afiliados, (d) GeneraciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n de cÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³digos QR para marketing de propiedades, (e) Sistema seguro de gestiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n de documentos, (f) GeneraciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n de prospectos y gestiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n de consultas." },
        { heading: "3. RESPONSABILIDADES DEL AGENTE", content: "El Agente garantiza y declara que: (a) Toda la informaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n de la propiedad proporcionada es precisa y completa, (b) El Agente ha obtenido la autorizaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n adecuada del propietario para listar la propiedad, (c) El propietario estÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡ informado y consiente la estructura de comisiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n, (d) Se han realizado todas las divulgaciones requeridas al propietario, (e) El Agente responderÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡ prontamente a todas las consultas generadas a travÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©s de la Plataforma." },
        { heading: "4. CLÃƒÆ’Ã†â€™Ãƒâ€šÃ‚ÂUSULA DE NO INTERMEDIACIÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œN", content: "La Plataforma se compromete a no contactar directamente a los clientes del Agente excepto para los siguientes propÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³sitos: (a) Presentar ofertas legÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­timas de compra, (b) Discutir opciones de financiamiento para compradores calificados, (c) Coordinar visitas a la propiedad a solicitud del Agente. Todas las demÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡s comunicaciones se dirigirÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡n a travÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©s del Agente." },
        { heading: "5. AUTORIZACIÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œN DEL PROPIETARIO", content: "El Agente certifica que el propietario ha proporcionado autorizaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n por escrito para listar la propiedad y estÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡ informado de: (a) La estructura de comisiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n y el acuerdo de divisiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n, (b) El papel de la Plataforma en el marketing y promociÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n de la propiedad, (c) El potencial de facilitaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n de financiamiento a travÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©s de servicios afiliados." },
        { heading: "6. PERÃƒÆ’Ã†â€™Ãƒâ€šÃ‚ÂODO DE LISTADO EXCLUSIVO", content: "Este acuerdo otorga a la Plataforma derechos exclusivos de marketing para la propiedad listada por un perÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­odo de 180 dÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­as desde la fecha de aprobaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n, a menos que se termine por acuerdo mutuo por escrito." },
        { heading: "7. TÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â°RMINOS DE PAGO", content: "El pago de la comisiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n se procesarÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡ dentro de 5 dÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­as hÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡biles despuÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©s del cierre exitoso y la recepciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n de toda la documentaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n requerida. El pago se realizarÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡ mediante transferencia bancaria o cheque certificado a la cuenta designada del Agente." },
        { heading: "8. TERMINACIÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œN", content: "Cualquiera de las partes puede terminar este acuerdo con 30 dÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­as de aviso por escrito. Cualquier transacciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n pendiente al momento de la terminaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n permanecerÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡ sujeta a los tÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©rminos de comisiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n aquÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­ establecidos." },
        { heading: "9. RESOLUCIÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œN DE DISPUTAS", content: "Cualquier disputa que surja de este acuerdo se resolverÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡ mediante arbitraje vinculante de acuerdo con las leyes del Estado de California y las leyes aplicables de MÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©xico para propiedades ubicadas en el mismo." },
        { heading: "10. INDEMNIZACIÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œN", content: "El Agente acepta indemnizar y eximir de responsabilidad a la Plataforma de cualquier reclamo, daÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â±o o responsabilidad que surja de informaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n inexacta de la propiedad, listados no autorizados o incumplimiento del deber fiduciario con los clientes." }
      ],
      acknowledgment: "Al firmar a continuaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n, el Agente reconoce que ha leÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­do, entendido y acepta estar obligado por todos los tÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©rminos y condiciones establecidos en este Acuerdo. El Agente certifica que tiene la autoridad para celebrar este acuerdo y que toda la informaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n proporcionada es verdadera y precisa.",
      signatureLabel: "Firma del Agente (Escriba Nombre Completo)",
      dateLabel: "Fecha",
      agreeCheckbox: "He leÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­do y acepto los tÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©rminos y condiciones de este Acuerdo Exclusivo de Listado y ComisiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n",
      submitButton: "Firmar y Enviar Acuerdo",
      footer: "Este acuerdo se rige por las leyes del Estado de California, EE.UU., y las leyes aplicables de MÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©xico. Para preguntas sobre este acuerdo, contacte legal@auditdna.com"
    }
  };
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex justify-end mb-6">
          <div className="bg-white rounded-lg shadow-sm p-1 flex gap-1">
            ...
            <button onClick={() => setLanguage('spanish')} className={`px-6 py-2 rounded-md font-medium transition-all ${language === 'spanish' ? 'bg-gradient-to-r from-purple-600 to-pink-600 text-white' : 'text-gray-600 hover:bg-gray-100'}`}>EspaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â±ol</button>
          </div>
        </div>
          ...
          <div className="p-8 space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 mt-8 pt-8 border-t-2 border-gray-300">
              <div className="bg-blue-50 rounded-lg p-6 space-y-2">
                ...
                <p className="text-sm text-gray-600 font-medium">{language === 'english' ? 'Agent Information:' : 'InformaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â³n del Agente:'}</p>
                <p className="text-gray-900"><strong>{language === 'english' ? 'Name:' : 'Nombre:'}</strong> {agentData.fullName}</p>
                <p className="text-gray-900"><strong>{language === 'english' ? 'Agency:' : 'Agencia:'}</strong> {agentData.agency}</p>
                <p className="text-gray-900"><strong>{language === 'english' ? 'Email:' : 'Correo:'}</strong> {agentData.email}</p>
                <p className="text-gray-900"><strong>{language === 'english' ? 'Phone:' : 'TelÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©fono:'}</strong> {agentData.phone}</p>
              </div>
