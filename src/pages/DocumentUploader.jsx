...
export default function MortgageTabUS() {
  ...
  function matchLenders() {
    ...
    if (searchEngine === "mexico-financing") {
      ...
      const minFico =
        (mexicoLender.minFICO &&
          mexicoLender.minFICO["MEXICO_PURCHASE"]) ||
        680;
      ...
      setResults([
        {
          ...
          notes:
            "Mexico Financing available for US citizens. US credit/income/asset verification required. Underwritten to international lending standards. Close in Mexico.",
        },
      ]);
      setSelectedProperty({
        address: "Mexico Property (Details Provided at Application)",
      });
      return;
    }
    ...
    const realLenders = lenders.filter(
      (lender) =>
    ...
    matches.sort(
      (a, b) => parseFloat(a.estimatedRate) - parseFloat(b.estimatedRate)
    );
    setResults(matches);
    ...
    <div className="space-y-8 pb-12">
      ...
      <div className="flex justify-start items-center gap-8 mb-4">
        ...
        >
          ...
          <option value="mexico-financing">
            Mexico Financing (US Citizens Only)
          </option>
        </select>
      </div>
      ...
      <div className="bg-gradient-to-r from-green-600 via-teal-600 to-blue-600 rounded-lg shadow-2xl p-8 text-white">
        ...
        <p className="text-xl">
          Real-Time Lender Matching Ã¢â‚¬Â¢ Professional Service
          Real-Time Lender Matching ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢ Professional Service
        </p>
      </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="space-y-6">
            {results.map((result, idx) => (
              <div
                key={idx}
                className="border-2 border-gray-200 rounded-lg p-6 hover:border-green-400 transition-all"
              >
                ...
                <div className="mt-4 pt-4 border-t border-gray-200">
                  ...
                  <p className="text-xs text-gray-500 mt-2">
                    *Principal & Interest only. Does not include taxes,
                    insurance, or HOA.
                    <br />
                    {result.notes}
                  </p>
