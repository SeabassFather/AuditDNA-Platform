  ...
  const productCategories = [
    {
      ...
      storageTemp: '-18Ãƒâ€šÃ‚Â°C (0Ãƒâ€šÃ‚Â°F)',
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-green-700 via-emerald-600 to-green-700 rounded-xl p-8 text-white">
        <div className="flex items-center gap-4 mb-4">
          <div className="text-6xl">ÃƒÂ°Ã…Â¸Ã‚Â¥Ã¢â‚¬Ëœ</div>
          <div>
            <h1 className="text-4xl font-black mb-2">Frozen Avocado & Guacamole Intelligence</h1>
            <p className="text-green-100 text-lg">Market intelligence ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Pricing ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Suppliers ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Buyers</p>
          </div>
        </div>
      </div>
              ...
              {suppliers.map((supplier, idx) => (
                <div key={idx} className="border-2 border-gray-200 rounded-lg p-4">
                  ...
                  <div className="text-sm text-gray-600">
                    {supplier.location} ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ {supplier.volume}
                  </div>
                </div>
              ))}
            </div>
