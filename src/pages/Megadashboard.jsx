...
export default function Megadashboard() {
  ...
  const modules = [
    { name: 'Financial Services', icon: 'ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Â°', path: '/financial', desc: 'Click to Access ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢', border: '#3b82f6', bg: '#23293a', color: '#fff' },
    { name: 'Real Estate', icon: 'ÃƒÂ°Ã…Â¸Ã‚ÂÃ‚Â ', path: '/real-estate', desc: 'Click to Access ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢', border: '#22c55e', bg: '#23293a', color: '#fff' },
    { name: 'Agriculture', icon: 'ÃƒÂ°Ã…Â¸Ã…â€™Ã‚Â½', path: '/agriculture', desc: 'Click to Access ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢', border: '#eab308', bg: '#23293a', color: '#fff' },
    { name: 'Compliance', icon: 'ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦', path: '/compliance', desc: 'Click to Access ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢', border: '#64748b', bg: '#23293a', color: '#fff' },
    { name: 'Analytics', icon: <img alt="analytics" src="https://img.icons8.com/fluency/48/000000/combo-chart.png" style={{height:"2rem"}} />, path: '/analytics', desc: 'Click to Access ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢', border: '#3b82f6', bg: '#23293a', color: '#fff' },
    { name: 'Mexico Ops', icon: 'MX', path: '/mexico', desc: 'Click to Access ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢', border: '#22c55e', bg: '#23293a', color: '#fff' },
  ];
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span style={{
                ...
                ÃƒÂ°Ã…Â¸Ã‚ÂÃ‚Â  Mortgage Rates
              </span>
              <span style={{
                fontSize: '0.7rem',
                background: '#22c55e',
