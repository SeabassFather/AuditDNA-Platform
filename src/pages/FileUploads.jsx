        ...
        <div className="col-lg-8 mx-auto">
          ...
          >
            ...
            <div className="card-body text-center py-5">
              <div className="mb-4">
                <div className="display-1 text-muted mb-3">Ã°Å¸â€œÂ</div>
                <div className="display-1 text-muted mb-3">ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€šÃ‚Â</div>
                  ...
                  <tr key={file.id}>
                    <td>
                      <div className="d-flex align-items-center">
                        <div className="me-3">
                          {file.type === 'PDF' && 'Ã°Å¸â€œâ€ž'}
                          {file.type === 'EXCEL' && 'Ã°Å¸â€œÅ '}
                          {file.type === 'ZIP' && 'Ã°Å¸â€”â€šÃ¯Â¸Â'}
                          {!['PDF', 'EXCEL', 'ZIP'].includes(file.type) && 'Ã°Å¸â€œâ€¹'}
                          {file.type === 'PDF' && 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒÂ¢Ã¢â€šÂ¬Ã…Â¾'}
                          {file.type === 'EXCEL' && 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€¦Ã‚Â '}
                          {file.type === 'ZIP' && 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬ÂÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã‚Â¯Ãƒâ€šÃ‚Â¸Ãƒâ€šÃ‚Â'}
                          {!['PDF', 'EXCEL', 'ZIP'].includes(file.type) && 'ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¹'}
                        </div>
                        <div>
