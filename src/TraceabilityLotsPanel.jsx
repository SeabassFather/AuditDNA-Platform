...
// EN/ES readyâ€”add translations as needed

export default function TraceabilityLotsPanel({ lots, language }) {
  const t = {
    en: { 
      ...
      compliance: "Compliance", tests: "Tests", stages: "Supply Chain Stages",
      print: "Print", pdf: "Export PDF", email: "Send Email", download: "Download", viewChain: "View Chain"
    },
    es: { 
      title: "Inteligencia de Trazabilidad", lot: "Lote", product: "Producto", variety: "Variedad", region: "RegiÃ³n", size: "TamaÃ±o", pack: "Empaque",
      status: "Estado", auditScore: "PuntuaciÃ³n", certifications: "Certificaciones", chain: "Cadena de TÃ­tulo", qr: "CÃ³digo QR",
      compliance: "Cumplimiento", tests: "Pruebas", stages: "Etapas de Cadena",
      print: "Imprimir", pdf: "Exportar PDF", email: "Enviar Email", download: "Descargar", viewChain: "Ver Cadena"
    }
  }[language || "en"];

  const getStatusColor = (status) => status === 'VERIFIED' ? '#10b981' : status === 'PENDING' ? '#f59e0b' : '#ef4444';
