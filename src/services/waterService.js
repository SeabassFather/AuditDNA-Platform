...
exports.calculateTDS = (conductivity, temperature = 25) => {
  // TDS (ppm) = Conductivity (ÃŽÂ¼S/cm) Ãƒâ€” 0.5 to 0.7 (conversion factor)
  // Temperature correction: conductivity increases ~2% per Ã‚Â°C
  // TDS (ppm) = Conductivity (ÃƒÆ’Ã…Â½Ãƒâ€šÃ‚Â¼S/cm) ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â 0.5 to 0.7 (conversion factor)
  // Temperature correction: conductivity increases ~2% per ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â°C
...
exports.calculateHardness = (calcium, magnesium) => {
  // Hardness (mg/L as CaCO3) = 2.5 Ãƒâ€” Ca + 4.1 Ãƒâ€” Mg
  // Hardness (mg/L as CaCO3) = 2.5 ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Ca + 4.1 ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Mg
...
exports.calculateLSI = (pH, temperature, tds, calcium, alkalinity) => {
  ...
  // pHs = (9.3 + A + B) - (C + D)
  // A = (log10[TDS] - 1) / 10
  // B = -13.12 Ãƒâ€” log10(Ã‚Â°C + 273) + 34.55
  // B = -13.12 ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â log10(ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â°C + 273) + 34.55
