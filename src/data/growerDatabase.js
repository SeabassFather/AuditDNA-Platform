...
export const growerDatabase = [
  {
    ...
    location: {
      ...
      region: 'MichoacÃƒÂ¡n',
      state: 'MichoacÃƒÂ¡n',
      region: 'MichoacÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡n',
      state: 'MichoacÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡n',
      country: 'Mexico',
    ...
    contact: {
      ...
      name: 'Miguel HernÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡ndez',
    ...
    bio: 'Leading Hass avocado producer in MichoacÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡n with organic certification and modern processing facilities.'
  },
  {
    id: 'GRW-002',
  ...
  },
  {
    ...
    contact: {
      ...
      name: 'Roberto GarcÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­a',
  ...
  },
  {
    ...
    companyName: 'Pimientos JalapeÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â±os SA',
    dba: 'JalapeÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â±o King',
    type: 'grower',
    location: {
      city: 'Delicias',
      region: 'Chihuahua',
    ...
    commodities: ['JalapeÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â±o Peppers', 'Bell Peppers', 'Serrano Peppers'],
    organic: false,
    certifications: ['globalgap', 'primusgfs', 'senasica'],
