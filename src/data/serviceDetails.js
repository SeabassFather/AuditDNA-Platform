export const SERVICE_DETAILS = {
  "Mortgage Loan Audit": {
    brief:
      "Line-by-line review of loan file, disclosures, and servicing for compliance and refund opportunities.",
  ...
  "Promissory Note Audit": {
    brief:
      "Validate principal, interest, amortization, riders, and assignments.",
  ...
  "Cross-Border Factoring (MXUSA)": {
    brief:
      "Invoice factoring intake for produce + cross-border shipments with PACA/KYC steps.",
    ...
    form: [
      ...
      },
      {
        ...
        label: "Country",
        type: "select",
        options: ["Mexico", "USA", "Canada", "Other"],
        required: true,
      },
      { name: "monthlyAR", label: "Monthly A/R (USD)", type: "number" },
      {
        ...
        label: "Industry",
        type: "select",
        options: ["Produce", "Manufacturing", "Logistics", "Other"],
      },
  ...
  "Commodity Catalog (USDA codes)": {
    brief:
      "USDA-based commodity taxonomy for matching buyers/sellers and pricing views.",
...
export const defaultDetails = (name) => ({
  brief:
    "Module description coming soon. Configure requirements, forms, and workflow in Admin.",
  tags: ["TBD"],
  docs: ["NDA (Mutual)"],
  form: [
