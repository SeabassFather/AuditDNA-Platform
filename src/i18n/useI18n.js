...
export function useI18n() {
  ...
  const dict = useMemo(
    () => ({
      ...
      es: {
        marketplace: "Mercado AgrÃƒÂ­cola",
        marketplace: "Mercado AgrÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­cola",
        buyer: "Comprador",
        seller: "Vendedor",
        compare: "Comparar",
        ...
        prices: "GrÃƒÂ¡ficas Semanales de Precios (USDA)",
        prices: "GrÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡ficas Semanales de Precios (USDA)",
        commodity: "Producto",
      },
    }),
    [],
