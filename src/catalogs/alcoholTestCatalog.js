...
export const alcoholTestCatalog = [
  ...
  { id: 'alc-specific-gravity', name: 'Specific Gravity', category: 'Purity', price: 45, description: 'Density at 20Ãƒâ€šÃ‚Â°C (ASTM D891)', parameters: ['Specific Gravity'], tags: ['density', 'ASTM'] },
  { id: 'alc-proof', name: 'Alcohol Proof', category: 'Purity', price: 55, description: 'Beverage alcohol strength (% ABV ÃƒÆ’Ã¢â‚¬â€ 2)', parameters: ['Proof', 'ABV %'], tags: ['proof', 'beverage', 'spirits'] },
  ...
  { id: 'alc-conductivity', name: 'Electrical Conductivity', category: 'Industrial', price: 55, description: 'Ionic impurity level', parameters: ['Conductivity', 'Ãƒâ€šÃ‚ÂµS/cm'], tags: ['conductivity', 'ionic'] },
