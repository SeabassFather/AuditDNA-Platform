...
const tabs = [
  { id: "water", label: "WaterTech", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Â§" },
  { id: "soil", label: "Soil Science", icon: "ÃƒÂ°Ã…Â¸Ã…â€™Ã‚Â±" },
  { id: "fertilizer", label: "Fertilizer Audit", icon: "ÃƒÂ°Ã…Â¸Ã‚Â§Ã‚Âª" },
  { id: "environment", label: "Environmental Monitor", icon: "ÃƒÂ°Ã…Â¸Ã…â€™Ã‚Â" },
  { id: "certifications", label: "Certifications", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã…â€œ" },
  { id: "traceability", label: "Traceability Map", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬â€Ã‚ÂºÃƒÂ¯Ã‚Â¸Ã‚Â" },
];
  ...
  return (
    <div className="dashboard-bg">
      <header className="dashboard-header">
        ...
        <h2>
          Futuristic Environmental & Agricultural Traceability Ãƒâ€šÃ‚Â· Real-Time AI Analysis Ãƒâ€šÃ‚Â· Blockchain-Ready Compliance
        </h2>
      </header>
  ...
  return (
    <section>
      ...
      <ul className="dashboard-feature-list">
        ...
        <li>Eco Sustainability Index (0ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“100) & AI risk flagging</li>
      </ul>
      <div className="dashboard-actions">
        <button className="dashboard-btn dashboard-btn-primary" onClick={onFetch}>
