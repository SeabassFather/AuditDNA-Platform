  ...
  deficiencies: [
    {
      ...
      human_health: {
        ...
        negative: ['Excess nitrates ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ methemoglobinemia (blue baby syndrome)', 'Carcinogenic nitrosamine formation']
      },
    ...
    },
    {
      ...
      human_health: {
        ...
        negative: ['Excess in water ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ eutrophication', 'Algal blooms']
      },
    ...
    },
    {
      ...
      human_health: {
        ...
        negative: ['Deficiency ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ muscle weakness, cardiac arrhythmia']
      },
    ...
    },
    {
      ...
      human_health: {
        ...
        negative: ['Excess ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ liver damage (hemochromatosis)', 'Oxidative stress']
      },
    ...
    },
    {
      ...
      human_health: {
        ...
        negative: ['Deficiency ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ growth retardation, immune dysfunction']
      },
    ...
    },
    {
      ...
      human_health: {
        ...
        negative: ['Deficiency ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ osteoporosis, rickets']
      },
...
// IoT Sensors
const IOT_SENSORS = [
  { id: 1, name: 'pH Sensor', range: '0-14 pH', accuracy: 'Ãƒâ€šÃ‚Â±0.1 pH', connectivity: 'WiFi/LoRa', price: '$150-$400', alerts: 'Real-time threshold alerts' },
  { id: 2, name: 'Dissolved Oxygen', range: '0-20 mg/L', accuracy: 'Ãƒâ€šÃ‚Â±0.2 mg/L', connectivity: 'WiFi/LoRa', price: '$300-$800', alerts: 'Low oxygen warnings' },
  { id: 3, name: 'EC/TDS Meter', range: '0-10,000 Ãƒâ€šÃ‚ÂµS/cm', accuracy: 'Ãƒâ€šÃ‚Â±2%', connectivity: 'WiFi/LoRa', price: '$200-$500', alerts: 'Salinity alerts' },
  { id: 4, name: 'Nitrate Sensor', range: '0-100 ppm', accuracy: 'Ãƒâ€šÃ‚Â±5%', connectivity: 'WiFi/LoRa', price: '$400-$1,200', alerts: 'Contamination alerts' },
  { id: 5, name: 'Soil Moisture', range: '0-100%', accuracy: 'Ãƒâ€šÃ‚Â±3%', connectivity: 'WiFi/LoRa', price: '$100-$300', alerts: 'Irrigation triggers' },
  { id: 6, name: 'Temperature Probe', range: '-40 to 125Ãƒâ€šÃ‚Â°C', accuracy: 'Ãƒâ€šÃ‚Â±0.5Ãƒâ€šÃ‚Â°C', connectivity: 'WiFi/LoRa', price: '$80-$200', alerts: 'Freeze/heat warnings' }
];
    ...
    <div className="space-y-6">
      ...
      <div className="border-2 border-dashed border-cyan-400/50 rounded-lg p-8 text-center hover:border-cyan-400 transition">
        ...
        <label htmlFor="file-upload" className="cursor-pointer">
          ...
          <div className="text-sm text-gray-400">PDF, CSV, or Excel ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Water or Soil Tests</div>
        </label>
      </div>
        ...
        <div className="bg-white/10 rounded-lg p-6 space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-sm text-gray-400">{results.sampleType} ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ {results.uploadDate}</div>
            </div>
    ...
    <div className="bg-white/5 rounded-lg p-4 border border-white/10">
      ...
      {expanded && (
        <div className="mt-4 space-y-3 text-sm">
          {db.health_impact && (
            <div>
              <div className="font-semibold text-red-400 mb-1">ÃƒÂ¢Ã…Â¡Ã‚Â ÃƒÂ¯Ã‚Â¸Ã‚Â Health Impacts:</div>
          ...
          {db.sources && (
            <div>
              <div className="font-semibold text-yellow-400 mb-1">ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â Sources:</div>
          ...
          {db.treatment && (
            <div>
              <div className="font-semibold text-green-400 mb-1">ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã…Â  Treatment:</div>
          ...
          {db.bioaccumulation && (
            <div>
              <div className="font-semibold text-purple-400 mb-1">ÃƒÂ°Ã…Â¸Ã‚Â§Ã‚Â¬ Bioaccumulation:</div>
          ...
          {db.food_impact && (
            <div>
              <div className="font-semibold text-blue-400 mb-1">ÃƒÂ°Ã…Â¸Ã‚ÂÃ…Â½ Food Impact:</div>
