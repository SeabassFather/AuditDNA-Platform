  ...
  return (
    <div style={{padding: '40px', background: '#0f172a', minHeight: '100vh', color: 'white'}}>
      <h1 style={{fontSize: '2.5rem', color: '#06b6d4', marginBottom: '30px'}}>
        ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Â§ {language === 'es' ? 'AnÃƒÆ’Ã‚Â¡lisis de Calidad del Agua' : 'Water Quality Analysis'}
      </h1>
      ...
      <div style={{
        ...
        {[
          {num: 1, label: language === 'es' ? 'Contacto' : 'Contact', icon: 'ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã¢â‚¬Â¹'},
          {num: 2, label: language === 'es' ? 'Pruebas' : 'Tests', icon: 'ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â¬'},
          {num: 3, label: language === 'es' ? 'UbicaciÃƒÆ’Ã‚Â³n' : 'Location', icon: 'ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â'},
          {num: 4, label: language === 'es' ? 'Condiciones' : 'Conditions', icon: 'ÃƒÂ°Ã…Â¸Ã…â€™Ã‚Â¡ÃƒÂ¯Ã‚Â¸Ã‚Â'},
          {num: 5, label: language === 'es' ? 'Cargar' : 'Upload', icon: 'ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â¤'},
          {num: 6, label: language === 'es' ? 'Pago' : 'Payment', icon: 'ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Â³'},
          {num: 7, label: language === 'es' ? 'QR' : 'QR Code', icon: 'ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â±'}
        ].map(s => (
          <div key={s.num} style={{
            textAlign: 'center',
      ...
      {step === 2 && (
        <>
          ...
          <button
            onClick={() => {
              if (selectedTests.length === 0) {
                alert(language === 'es' ? 'ÃƒÂ¢Ã…Â¡Ã‚Â ÃƒÂ¯Ã‚Â¸Ã‚Â Seleccione al menos una prueba!' : 'ÃƒÂ¢Ã…Â¡Ã‚Â ÃƒÂ¯Ã‚Â¸Ã‚Â Please select at least one test!');
                return;
              }
              setStep(3);
            }}
          ...
          >
            {language === 'es' ? 'ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Continuar a UbicaciÃƒÆ’Ã‚Â³n' : 'ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Continue to Location'}
          </button>
        </>
      )}
        ...
        <div>
          ...
          <div style={{
            ...
            <h2 style={{color: '#10b981', marginBottom: '20px'}}>
              ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ {language === 'es' ? 'Ãƒâ€šÃ‚Â¡AnÃƒÆ’Ã‚Â¡lisis Completo!' : 'Analysis Complete!'}
            </h2>
            <div style={{fontSize: '4rem', marginBottom: '15px'}}>ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Â§</div>
            ...
            >
              ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã¢â‚¬Å¾ {language === 'es' ? 'Descargar Reporte' : 'Download Report'}
            </button>
            <button 
              onClick={() => {
                setStep(1); 
            ...
            >
              ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ¢â‚¬Å¾ {language === 'es' ? 'Nuevo AnÃƒÆ’Ã‚Â¡lisis' : 'New Analysis'}
            </button>
          </div>
        </div>
      )}
