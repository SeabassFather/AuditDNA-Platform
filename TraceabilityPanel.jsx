...
export default function TraceabilityPanel({ lots, language }) {
  const t = {
    ...
    es: {
      title: "Inteligencia de Trazabilidad", lot: "Lote", product: "Producto", variety: "Variedad", region: "Región", size: "Tamaño", pack: "Empaque",
      status: "Estado", auditScore: "Puntuación", certifications: "Certificaciones", chain: "Cadena de Título", qr: "Código QR",
