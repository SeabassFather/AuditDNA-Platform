...
export default function FinancialServices() {
  ...
  const tabs = [
    { id: 'factoring', label: 'Invoice Factoring', icon: 'Ã°Å¸â€™Âµ' },
    { id: 'payment-terms', label: 'Payment Terms', icon: 'Ã°Å¸â€œâ€¦' },
    { id: 'credit-risk', label: 'Credit Risk', icon: 'Ã¢Å¡Â Ã¯Â¸Â' },
    { id: 'working-capital', label: 'Working Capital', icon: 'Ã°Å¸â€œË†' },
    { id: 'currency', label: 'Currency Exchange', icon: 'Ã°Å¸Å’Â' },
    { id: 'reports', label: 'Financial Reports', icon: 'Ã°Å¸â€œÅ ' }
  ];
...
// =================================function PaymentTermsTab() {
  return (
    <div style={{ textAlign: 'center', padding: '60px 20px' }}>
      <div style={{ fontSize: '4rem', marginBottom: '24px' }}>Ã°Å¸â€œâ€¦</div>
...
// =================================function CreditRiskTab() {
  return (
    <div style={{ textAlign: 'center', padding: '60px 20px' }}>
      <div style={{ fontSize: '4rem', marginBottom: '24px' }}>Ã¢Å¡Â Ã¯Â¸Â</div>
      <h2 style={{ fontSize: '2rem', fontWeight: '800', color: '#0f172a', marginBottom: '16px' }}>
...
// =================================function WorkingCapitalTab() {
  return (
    <div style={{ textAlign: 'center', padding: '60px 20px' }}>
      <div style={{ fontSize: '4rem', marginBottom: '24px' }}>Ã°Å¸â€œË†</div>
      <h2 style={{ fontSize: '2rem', fontWeight: '800', color: '#0f172a', marginBottom: '16px' }}>
...
// =================================function CurrencyTab() {
  return (
    <div style={{ textAlign: 'center', padding: '60px 20px' }}>
      <div style={{ fontSize: '4rem', marginBottom: '24px' }}>Ã°Å¸Å’Â</div>
      <h2 style={{ fontSize: '2rem', fontWeight: '800', color: '#0f172a', marginBottom: '16px' }}>
        Currency Exchange
      </h2>
      <p style={{ fontSize: '1.1rem', color: '#64748b', marginBottom: '32px' }}>
...
// =================================function ReportsTab() {
  const reports = [
    { name: 'Summary Report', icon: 'Ã°Å¸â€œÅ ', desc: 'Key financial metrics and KPIs', color: '#3b82f6' },
    { name: 'AR Aging Report', icon: 'Ã°Å¸â€œâ€¦', desc: 'Accounts receivable aging analysis', color: '#22c55e' },
    { name: 'Profitability Analysis', icon: 'Ã°Å¸â€™Â°', desc: 'Product-level profit margins', color: '#8b5cf6' },
    { name: 'Cash Flow Statement', icon: 'Ã°Å¸â€™Âµ', desc: 'Operating, investing, financing activities', color: '#eab308' }
  ];
