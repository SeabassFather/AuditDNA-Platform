...
export const fuelOilTestCatalog = [
  ...
  { id: 'fuel-cloud-point', name: 'Cloud Point', category: 'Diesel Fuel', price: 65, description: 'Temperature diesel starts to gel (ASTM D2500)', parameters: ['Cloud Point', 'Ã‚Â°C'], tags: ['diesel', 'cold weather', 'ASTM'] },
  { id: 'fuel-pour-point', name: 'Pour Point', category: 'Diesel Fuel', price: 65, description: 'Lowest flow temperature (ASTM D97)', parameters: ['Pour Point', 'Ã‚Â°C'], tags: ['diesel', 'cold weather'] },
  ...
  { id: 'fuel-lubricity-diesel', name: 'Lubricity (HFRR)', category: 'Diesel Fuel', price: 135, description: 'Fuel injection pump protection (ASTM D6079)', parameters: ['Wear Scar', 'Ã‚Âµm'], tags: ['diesel', 'lubricity', 'ASTM'] },
  ...
  { id: 'oil-viscosity-40c', name: 'Viscosity @ 40Ã‚Â°C', category: 'Oil Properties', price: 65, popular: true, description: 'Oil thickness at operating temp (ASTM D445)', parameters: ['Viscosity', 'cSt'], tags: ['oil', 'viscosity', 'ASTM'] },
  { id: 'oil-viscosity-100c', name: 'Viscosity @ 100Ã‚Â°C', category: 'Oil Properties', price: 65, description: 'High-temp viscosity (ASTM D445)', parameters: ['Viscosity', 'cSt'], tags: ['oil', 'viscosity'] },
  ...
  { id: 'oil-flash-point', name: 'Flash Point', category: 'Oil Properties', price: 75, description: 'Fire safety temperature (ASTM D92)', parameters: ['Flash Point', 'Ã‚Â°C'], tags: ['oil', 'safety', 'ASTM'] },
  { id: 'oil-pour-point', name: 'Pour Point (Oil)', category: 'Oil Properties', price: 65, description: 'Low-temp flow limit (ASTM D97)', parameters: ['Pour Point', 'Ã‚Â°C'], tags: ['oil', 'cold flow'] },
  ...
  { id: 'fuel-cold-filter', name: 'Cold Filter Plugging Point (CFPP)', category: 'Specialized', price: 115, description: 'Operability in cold (ASTM D6371)', parameters: ['CFPP', 'Ã‚Â°C'], tags: ['fuel', 'cold weather', 'ASTM'] },
  { id: 'fuel-density', name: 'Fuel Density', category: 'Specialized', price: 55, description: 'Specific gravity @ 15Ã‚Â°C (ASTM D4052)', parameters: ['Density', 'kg/mÃ‚Â³'], tags: ['fuel', 'density', 'ASTM'] },
