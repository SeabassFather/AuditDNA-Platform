...
exports.calculateTDS = (conductivity, temperature = 25) => {
  // TDS (ppm) = Conductivity (Î¼S/cm) Ã— 0.5 to 0.7 (conversion factor)
  // Temperature correction: conductivity increases ~2% per Â°C
  // TDS (ppm) = Conductivity (ÃƒÅ½Ã‚Â¼S/cm) ÃƒÆ’Ã¢â‚¬â€ 0.5 to 0.7 (conversion factor)
  // Temperature correction: conductivity increases ~2% per Ãƒâ€šÃ‚Â°C
...
exports.calculateHardness = (calcium, magnesium) => {
  // Hardness (mg/L as CaCO3) = 2.5 Ã— Ca + 4.1 Ã— Mg
  // Hardness (mg/L as CaCO3) = 2.5 ÃƒÆ’Ã¢â‚¬â€ Ca + 4.1 ÃƒÆ’Ã¢â‚¬â€ Mg
...
exports.calculateLSI = (pH, temperature, tds, calcium, alkalinity) => {
  ...
  // pHs = (9.3 + A + B) - (C + D)
  // A = (log10[TDS] - 1) / 10
  // B = -13.12 Ã— log10(Â°C + 273) + 34.55
  // B = -13.12 ÃƒÆ’Ã¢â‚¬â€ log10(Ãƒâ€šÃ‚Â°C + 273) + 34.55
