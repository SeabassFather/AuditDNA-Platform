    ...
    <div className="p-6 space-y-8">
      ...
      <section>
        ...
        <ul className="list-disc list-inside text-gray-700">
          <li>CFPB â€“ Consumer Lending, Fair Credit, UDAAP</li>
          <li>IRS â€“ Capital Gains, Corporate Tax, Income Tax</li>
          <li>CFPB ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ Consumer Lending, Fair Credit, UDAAP</li>
          <li>IRS ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ Capital Gains, Corporate Tax, Income Tax</li>
