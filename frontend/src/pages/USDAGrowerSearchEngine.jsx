        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <h1 className="text-4xl font-bold mb-2">ÃƒÂ°Ã…Â¸Ã…â€™Ã‚Â¾ USDA Grower Search Engine</h1>
        ...
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-2">
              ...
              {grower.organic && <span className="text-xs bg-green-100 text-green-800 px-2 py-1 rounded">ÃƒÂ°Ã…Â¸Ã…â€™Ã‚Â¿ Organic</span>}
    ...
    <div className="bg-white rounded-xl border border-gray-200 hover:shadow-xl transition overflow-hidden">
      <div className="bg-gradient-to-r from-green-500 to-green-600 px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          {grower.organic && <span className="text-xs bg-white text-green-700 px-2 py-1 rounded">ÃƒÂ°Ã…Â¸Ã…â€™Ã‚Â¿</span>}
        </div>
      </div>
