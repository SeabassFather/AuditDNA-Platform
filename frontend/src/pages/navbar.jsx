      ...
      sections: [
        {
          ...
          links: [
            { to: "/factoring", label: "Invoice Factoring", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Â°" },
            { to: "/financial", label: "Financial Suite", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Âµ" },
            { to: "/trade-finance", label: "Trade Finance", icon: "ÃƒÂ°Ã…Â¸Ã…â€™Ã‚Â" },
            { to: "/lender-match", label: "Lender Matching", icon: "ÃƒÂ°Ã…Â¸Ã‚Â¤Ã‚Â" }
          ]
        },
        {
          title: "Mexico Finance",
          links: [
            { to: "/mexico-finance", label: "Mexico Finance Hub", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬Â¡Ã‚Â²ÃƒÂ°Ã…Â¸Ã¢â‚¬Â¡Ã‚Â½" },
            { to: "/mexico-loans", label: "Mexico Loans", icon: "ÃƒÂ°Ã…Â¸Ã‚ÂÃ‚Â¦" },
            { to: "/mexico-refi", label: "Refinancing", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã…Â " }
          ]
        },
        {
          title: "Trade & Capital",
          links: [
            { to: "/trade-finance/search", label: "Trade Search", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â" },
            { to: "/lending-options", label: "Lending Options", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Â³" },
            { to: "/loan-match", label: "Loan Calculator", icon: "ÃƒÂ°Ã…Â¸Ã‚Â§Ã‚Â®" }
          ]
        }
      ]
    },
      ...
      sections: [
        {
          title: "US Mortgage",
          links: [
            { to: "/mortgage", label: "Mortgage Hub", icon: "ÃƒÂ°Ã…Â¸Ã‚ÂÃ‚Â " },
            { to: "/us-mortgage", label: "US Mortgage Loans", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬Â¡Ã‚ÂºÃƒÂ°Ã…Â¸Ã¢â‚¬Â¡Ã‚Â¸" },
            { to: "/mortgage/us", label: "US Mortgage Search", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ…Â½" },
            { to: "/mortgage/search", label: "Mortgage Calculator", icon: "ÃƒÂ°Ã…Â¸Ã‚Â§Ã‚Â®" }
          ]
        },
        {
          title: "Mexico Real Estate",
          links: [
            { to: "/mortgage/mexico", label: "Mexico Mortgage", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬Â¡Ã‚Â²ÃƒÂ°Ã…Â¸Ã¢â‚¬Â¡Ã‚Â½" },
            { to: "/mortgage/real-estate", label: "Real Estate Portal", icon: "ÃƒÂ°Ã…Â¸Ã‚ÂÃ‹Å“ÃƒÂ¯Ã‚Â¸Ã‚Â" },
            { to: "/property/search", label: "Property Search", icon: "ÃƒÂ°Ã…Â¸Ã‚ÂÃ‚Â¡" }
          ]
        },
        {
          title: "Agent Tools",
          links: [
            { to: "/real-estate/agent", label: "Agent Dashboard", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬ËœÃ¢â‚¬Â" },
            { to: "/real-estate/register", label: "Agent Registration", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â" },
            { to: "/title-search", label: "Title Search", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã…â€œ" },
            { to: "/escrow", label: "Escrow Services", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ¢â‚¬â„¢" }
          ]
        }
      ]
    },
      ...
      sections: [
        {
          ...
          links: [
            { to: "/agriculture", label: "Ag Main Hub", icon: "ÃƒÂ°Ã…Â¸Ã…â€™Ã‚Â¾" },
            { to: "/ag-marketplace", label: "Ag Marketplace", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂºÃ¢â‚¬â„¢" },
            { to: "/ag-explorer", label: "Ag Explorer", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬â€Ã‚ÂºÃƒÂ¯Ã‚Â¸Ã‚Â" },
            { to: "/ag-main", label: "Ag Main Page", icon: "ÃƒÂ°Ã…Â¸Ã…Â¡Ã…â€œ" }
          ]
        },
        {
          title: "Produce Markets",
          links: [
            { to: "/market", label: "Market Overview", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã…Â " },
            { to: "/market-prices", label: "Live Pricing", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Â¹" },
            { to: "/produce-prices", label: "Produce Pricing", icon: "ÃƒÂ°Ã…Â¸Ã‚Â¥Ã¢â‚¬Ëœ" },
            { to: "/produce-trends", label: "Market Trends", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‹â€ " }
          ]
        },
        {
          title: "Specialty Products",
          links: [
            { to: "/avocado-guacamole", label: "Avocado & Guacamole", icon: "ÃƒÂ°Ã…Â¸Ã‚Â¥Ã¢â‚¬Ëœ" },
            { to: "/produce-inquiry", label: "Product Inquiry", icon: "ÃƒÂ¢Ã‚ÂÃ¢â‚¬Å“" },
            { to: "/produce-market-pie", label: "Market Analytics", icon: "ÃƒÂ°Ã…Â¸Ã‚Â¥Ã‚Â§" }
          ]
        }
      ]
    },
      ...
      sections: [
        {
          ...
          links: [
            { to: "/usda", label: "USDA Hub", icon: "ÃƒÂ°Ã…Â¸Ã…â€™Ã‚Â½" },
            { to: "/usda/marketplace", label: "USDA Marketplace", icon: "ÃƒÂ°Ã…Â¸Ã‚ÂÃ‚Âª" },
            { to: "/usda/search", label: "USDA Search", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â" },
            { to: "/usda/grower-search", label: "Grower Database", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬ËœÃ‚Â¨ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ°Ã…Â¸Ã…â€™Ã‚Â¾" }
          ]
        },
        {
          title: "Organic & Specialty",
          links: [
            { to: "/usda/organic", label: "Organic Products", icon: "ÃƒÂ°Ã…Â¸Ã…â€™Ã‚Â±" },
            { to: "/produce-trends-all", label: "All Produce Trends", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã…Â " }
          ]
        }
      ]
    },
      ...
      sections: [
        {
          ...
          links: [
            { to: "/water", label: "Water Tech Hub", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Â§" },
            { to: "/traceability", label: "Traceability Module", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â¬" },
            { to: "/water-tech", label: "Water Technology", icon: "ÃƒÂ¢Ã…Â¡Ã¢â‚¬â€ÃƒÂ¯Ã‚Â¸Ã‚Â" },
            { to: "/water-tech/uploads", label: "Lab Uploads", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â¤" }
          ]
        }
      ]
    },
      ...
      sections: [
        {
          ...
          links: [
            { to: "/search", label: "Universal Search", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â" },
            { to: "/search-engines", label: "Search Engines Hub", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ…Â½" },
            { to: "/scanner", label: "Document Scanner", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã¢â‚¬Å¾" },
            { to: "/facial-recognition", label: "Facial Recognition", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬ËœÃ‚Â¤" }
          ]
        },
        {
          title: "Verification",
          links: [
            { to: "/five-verification", label: "5 Verification Engines", icon: "ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦" }
          ]
        }
      ]
    },
      ...
      sections: [
        {
          ...
          links: [
            { to: "/audit", label: "Audit Hub", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â" },
            { to: "/audit/catalog", label: "Audit Catalog", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã…Â¡" },
            { to: "/audit/report", label: "Audit Reports", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã…Â " },
            { to: "/audit/service-catalog", label: "Service Catalog", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂºÃ‚Â ÃƒÂ¯Ã‚Â¸Ã‚Â" }
          ]
        },
        {
          title: "Compliance",
          links: [
            { to: "/compliance", label: "Compliance Hub", icon: "ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦" },
            { to: "/compliance/dashboard", label: "Compliance Dashboard", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‹â€ " },
            { to: "/compliance/page", label: "Compliance Portal", icon: "ÃƒÂ°Ã…Â¸Ã‚ÂÃ¢â‚¬ÂºÃƒÂ¯Ã‚Â¸Ã‚Â" }
          ]
        }
      ]
    },
      ...
      sections: [
        {
          ...
          links: [
            { to: "/services", label: "All Services", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂºÃ‚Â ÃƒÂ¯Ã‚Â¸Ã‚Â" },
            { to: "/services/explorer", label: "Service Explorer", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬â€Ã‚ÂºÃƒÂ¯Ã‚Â¸Ã‚Â" },
            { to: "/services/catalog", label: "Catalog", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã¢â‚¬â€œ" },
            { to: "/consumer-services", label: "Consumer Services", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂºÃ‚ÂÃƒÂ¯Ã‚Â¸Ã‚Â" }
          ]
        },
        {
          title: "Documents",
          links: [
            { to: "/files", label: "File Manager", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â" },
            { to: "/upload", label: "Upload Center", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â¤" },
            { to: "/docusign", label: "DocuSign", icon: "ÃƒÂ¢Ã…â€œÃ‚ÂÃƒÂ¯Ã‚Â¸Ã‚Â" },
            { to: "/cases", label: "Cases", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã¢â‚¬Â¹" }
          ]
        }
      ]
    }
        ...
        <div className="max-w-[1920px] mx-auto">
          ...
          <div className="border-b border-white/10 px-6 py-2 flex items-center justify-between text-sm">
            <div className="flex items-center gap-4">
              <span className="text-gray-300">ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â Global Platform</span>
              <span className="text-gray-300">|</span>
              <span className="text-green-400 font-semibold">ÃƒÂ¢Ã…â€œÃ¢â‚¬Å“ All Systems Operational</span>
            </div>
            <div className="flex items-center gap-4 text-gray-300">
              <span>ÃƒÂ°Ã…Â¸Ã…â€™Ã‚Â Multi-Region</span>
              <span>|</span>
          ...
          <div className="px-6 py-4">
            <div className="flex items-center justify-between">
              ...
              <NavLink to="/" className="flex items-center gap-3 group">
                <div className="text-4xl group-hover:scale-110 transition-transform">ÃƒÂ°Ã…Â¸Ã‚Â§Ã‚Â¬</div>
                <div>
