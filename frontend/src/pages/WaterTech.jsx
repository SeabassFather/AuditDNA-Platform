...
export default function WaterTech() {
  ...
  const products = [
    ...
    { id: 12, nameEN: 'Lime Amendment', nameES: 'Enmienda de Cal', category: 'Suelo', status: 'Disponible', descEN: 'Raises soil pH for acidic soil conditions', descES: 'Aumenta el pH del suelo para condiciones Ã¡cidas', targets: 'pH Ãcido, Acidez del Suelo' },
    ...
    { id: 12, nameEN: 'Lime Amendment', nameES: 'Enmienda de Cal', category: 'Suelo', status: 'Disponible', descEN: 'Raises soil pH for acidic soil conditions', descES: 'Aumenta el pH del suelo para condiciones ÃƒÆ’Ã‚Â¡cidas', targets: 'pH ÃƒÆ’Ã‚Âcido, Acidez del Suelo' },
    { id: 13, nameEN: 'Sulfur Amendment', nameES: 'Enmienda de Azufre', category: 'Suelo', status: 'Disponible', descEN: 'Lowers soil pH for alkaline soil conditions', descES: 'Reduce el pH del suelo para condiciones alcalinas', targets: 'pH Alcalino, Alcalinidad' },
