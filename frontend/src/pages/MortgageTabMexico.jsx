...
export default function MortgageTabMexico() {
  ...
  const mexicoLenders = [
    {
      id: 1,
      regions: ['CDMX', 'Cancun', 'Tulum', 'Los Cabos', 'Puerto Vallarta', 'Guadalajara', 'Playa del Carmen', 'Monterrey', 'MazatlÃ¡n', 'La Paz', 'Sayulita', 'Punta Mita', 'Riviera Nayarit', 'Cozumel', 'Akumal'],
      regions: ['CDMX', 'Cancun', 'Tulum', 'Los Cabos', 'Puerto Vallarta', 'Guadalajara', 'Playa del Carmen', 'Monterrey', 'MazatlÃƒÆ’Ã‚Â¡n', 'La Paz', 'Sayulita', 'Punta Mita', 'Riviera Nayarit', 'Cozumel', 'Akumal'],
      minAmount: 50000,
      maxAmount: 5000000,
      baseRate: 7.50,
    ...
    {
      id: 4,
      regions: ['Los Cabos', 'Puerto Vallarta', 'MazatlÃ¡n', 'La Paz'],
      regions: ['Los Cabos', 'Puerto Vallarta', 'MazatlÃƒÆ’Ã‚Â¡n', 'La Paz'],
      minAmount: 50000,
      maxAmount: 1000000,
      baseRate: 9.125,
      foreignNational: true,
  ...
  const calculateRates = () => {
    ...
    if (!amount || amount < 50000) {
      alert('Por favor ingrese un monto vÃ¡lido (mÃ­nimo $50,000 USD)');
      alert('Por favor ingrese un monto vÃƒÆ’Ã‚Â¡lido (mÃƒÆ’Ã‚Â­nimo $50,000 USD)');
      return;
    }
    
    if (!propertyRegion) {
      alert('Por favor seleccione una regiÃ³n');
      alert('Por favor seleccione una regiÃƒÆ’Ã‚Â³n');
      return;
    }
    ...
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 rounded-lg shadow-2xl p-8 text-white">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <h1 className="text-4xl font-bold">PrÃ©stamos Hipotecarios en MÃ©xico</h1>
            <h1 className="text-4xl font-bold">PrÃƒÆ’Ã‚Â©stamos Hipotecarios en MÃƒÆ’Ã‚Â©xico</h1>
      ...
      <div className="bg-white rounded-lg shadow-lg p-8">
        <h2 className="text-2xl font-bold mb-6 flex items-center gap-3">
          ...
          Search Criteria / Criterios de BÃºsqueda
          Search Criteria / Criterios de BÃƒÆ’Ã‚Âºsqueda
        </h2>
        
        <div className="grid grid-cols-2 gap-6 mb-6">
          <div>
            <label className="block font-bold mb-2">Loan Purpose / PropÃ³sito</label>
            <label className="block font-bold mb-2">Loan Purpose / PropÃƒÆ’Ã‚Â³sito</label>
            <select 
              value={loanType}
          ...
          <div>
            <label className="block font-bold mb-2">Property Region / RegiÃ³n</label>
            <label className="block font-bold mb-2">Property Region / RegiÃƒÆ’Ã‚Â³n</label>
            <select 
            ...
            >
              ...
              <option value="CDMX">Ciudad de MÃ©xico (CDMX)</option>
              <option value="Cancun">CancÃºn, Quintana Roo</option>
              <option value="CDMX">Ciudad de MÃƒÆ’Ã‚Â©xico (CDMX)</option>
              <option value="Cancun">CancÃƒÆ’Ã‚Âºn, Quintana Roo</option>
              ...
              <option value="Monterrey">Monterrey, Nuevo LeÃ³n</option>
              <option value="MazatlÃ¡n">MazatlÃ¡n, Sinaloa</option>
              <option value="Monterrey">Monterrey, Nuevo LeÃƒÆ’Ã‚Â³n</option>
              <option value="MazatlÃƒÆ’Ã‚Â¡n">MazatlÃƒÆ’Ã‚Â¡n, Sinaloa</option>
          ...
          <div>
            <label className="block font-bold mb-2">Citizenship / CiudadanÃ­a</label>
            <label className="block font-bold mb-2">Citizenship / CiudadanÃƒÆ’Ã‚Â­a</label>
            <select 
              value={citizenship}
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="flex items-center gap-3 mb-6 p-4 bg-blue-50 border-2 border-blue-200 rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm text-gray-700 mt-1">
                Las tasas estimadas son aproximadas. Las tasas finales requieren solicitud completa, avalÃºo de propiedad, configuraciÃ³n de fideicomiso y aprobaciÃ³n de suscripciÃ³n.
                Las tasas estimadas son aproximadas. Las tasas finales requieren solicitud completa, avalÃƒÆ’Ã‚Âºo de propiedad, configuraciÃƒÆ’Ã‚Â³n de fideicomiso y aprobaciÃƒÆ’Ã‚Â³n de suscripciÃƒÆ’Ã‚Â³n.
              </p>
            </div>
          </div>
            ...
            {results.map((result, index) => (
              <div key={result.id} className="border-2 border-gray-200 rounded-lg p-6 hover:border-blue-400 transition-all">
                ...
                <div className="pt-4 border-t border-gray-200">
                  ...
                  <p className="text-xs text-gray-500">*Basado en plazo de 20 aÃ±os. Solo capital e interÃ©s. No incluye impuestos prediales, seguro o cuotas de fideicomiso.</p>
                  <p className="text-xs text-gray-500">*Basado en plazo de 20 aÃƒÆ’Ã‚Â±os. Solo capital e interÃƒÆ’Ã‚Â©s. No incluye impuestos prediales, seguro o cuotas de fideicomiso.</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="mt-6 bg-yellow-50 border-2 border-yellow-300 rounded-lg p-6">
            <h4 className="font-bold text-gray-800 mb-3 flex items-center gap-2">
              ...
              Required Documentation / DocumentaciÃ³n Requerida:
              Required Documentation / DocumentaciÃƒÆ’Ã‚Â³n Requerida:
            </h4>
            <ul className="space-y-2 text-sm text-gray-700">
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                Valid passport and proof of legal status in Mexico / Pasaporte vÃ¡lido y comprobante de estatus legal
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                Proof of income (2 years tax returns, bank statements) / Comprobante de ingresos (2 aÃ±os de declaraciones, estados de cuenta)
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                Property appraisal by approved Mexican appraiser / AvalÃºo por tasador mexicano aprobado
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                Fideicomiso (bank trust) setup for foreign buyers / ConfiguraciÃ³n de fideicomiso para compradores extranjeros
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                Credit report from home country / Reporte de crÃ©dito del paÃ­s de origen
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                Down payment typically 30-50% for foreign nationals / Enganche tÃ­picamente 30-50% para extranjeros
                Valid passport and proof of legal status in Mexico / Pasaporte vÃƒÆ’Ã‚Â¡lido y comprobante de estatus legal
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                Proof of income (2 years tax returns, bank statements) / Comprobante de ingresos (2 aÃƒÆ’Ã‚Â±os de declaraciones, estados de cuenta)
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                Property appraisal by approved Mexican appraiser / AvalÃƒÆ’Ã‚Âºo por tasador mexicano aprobado
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                Fideicomiso (bank trust) setup for foreign buyers / ConfiguraciÃƒÆ’Ã‚Â³n de fideicomiso para compradores extranjeros
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                Credit report from home country / Reporte de crÃƒÆ’Ã‚Â©dito del paÃƒÆ’Ã‚Â­s de origen
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                Down payment typically 30-50% for foreign nationals / Enganche tÃƒÆ’Ã‚Â­picamente 30-50% para extranjeros
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg shadow-lg p-8 border-2 border-gray-300">
        ...
        <div className="mt-6 pt-6 border-t-2 border-gray-300 space-y-3 text-sm text-gray-600">
          ...
          <p className="font-semibold mt-4">FINANCIAMIENTO DE PROPIEDAD EN MÃ‰XICO:</p>
          <p>
            Intermediamos prÃ©stamos de propiedades en MÃ©xico a travÃ©s de nuestra red de prestamistas aprobados. Todos los prÃ©stamos estÃ¡n sujetos a regulaciones bancarias mexicanas y requieren el establecimiento de un fideicomiso para propiedades dentro de la zona restringida.
          <p className="font-semibold mt-4">FINANCIAMIENTO DE PROPIEDAD EN MÃƒÆ’Ã¢â‚¬Â°XICO:</p>
          <p>
            Intermediamos prÃƒÆ’Ã‚Â©stamos de propiedades en MÃƒÆ’Ã‚Â©xico a travÃƒÆ’Ã‚Â©s de nuestra red de prestamistas aprobados. Todos los prÃƒÆ’Ã‚Â©stamos estÃƒÆ’Ã‚Â¡n sujetos a regulaciones bancarias mexicanas y requieren el establecimiento de un fideicomiso para propiedades dentro de la zona restringida.
          </p>
          ...
          <p className="text-xs text-gray-500 mt-4 text-center">
            Â© {new Date().getFullYear()} Everwise Home Loans & Realty. All Rights Reserved. | Todos los Derechos Reservados.
            Ãƒâ€šÃ‚Â© {new Date().getFullYear()} Everwise Home Loans & Realty. All Rights Reserved. | Todos los Derechos Reservados.
          </p>
        </div>
      </div>
    </div>
