...
const text = {
  ...
  spanish: {
    ...
    subtitle: "Use este formulario para preguntar, agendar una visita o solicitar mÃ¡s informaciÃ³n sobre una propiedad.",
    name: "Su Nombre",
    email: "Su Correo",
    phone: "NÃºmero de TelÃ©fono",
    subtitle: "Use este formulario para preguntar, agendar una visita o solicitar mÃƒÆ’Ã‚Â¡s informaciÃƒÆ’Ã‚Â³n sobre una propiedad.",
    name: "Su Nombre",
    email: "Su Correo",
    ...
    thankyou: "Â¡Gracias! El propietario le contactarÃ¡ pronto."
    thankyou: "Ãƒâ€šÃ‚Â¡Gracias! El propietario le contactarÃƒÆ’Ã‚Â¡ pronto."
  }
};
...
export default function OwnerContactCard({ language = "english" }) {
  ...
  const handleSubmit = e => {
    e.preventDefault();
    setSubmitted(true);
    // TODO: Integrate with backend/API for actual submission, email, or SMS.
  };
