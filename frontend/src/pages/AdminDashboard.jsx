                    ...
                    <div key={listing.listingId} className="border-2 border-yellow-200 rounded-xl p-6 bg-yellow-50 hover:shadow-lg transition-all">
                      <div className="flex justify-between items-start">
                        <div className="flex-1">
                          ...
                          <p className="text-gray-600 mb-3">{listing.region} â€¢ {listing.propertyType}</p>
                          ...
                          <div className="bg-white rounded-lg p-4 mb-4">
                            ...
                            <p className="text-sm text-gray-600">{listing.agentEmail} â€¢ {listing.agentPhone}</p>
                          </div>
                          <div className="bg-white rounded-lg p-4">
                            ...
                            <p className="text-sm text-gray-600">{listing.ownerEmail} â€¢ {listing.ownerPhone}</p>
                          </div>
                        </div>
        ...
        {selectedListing && activeTab === 'pending' && (
          <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center p-4 z-50" onClick={() => setSelectedListing(null)}>
            <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full p-8" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="mb-6"><h3 className="font-bold text-lg mb-2">{selectedListing.location}</h3><p className="text-gray-600">{selectedListing.region} â€¢ {formatPrice(selectedListing.price)}</p></div>
              <div className="space-y-4 mb-6">
                ...
                <div><p className="text-sm font-semibold text-gray-700">DescripciÃ³n (EspaÃ±ol):</p><p className="text-gray-600 bg-gray-50 p-3 rounded">{selectedListing.descriptionSpanish}</p></div>
              </div>
