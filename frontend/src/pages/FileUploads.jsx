          ...
          >
            ...
            <div className="card-body text-center py-5">
              <div className="mb-4">
                ...
                <div className="display-1 text-muted mb-3">ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â</div>
                  ...
                  <tr key={file.id}>
                    <td>
                      <div className="d-flex align-items-center">
                        <div className="me-3">
                          {file.type === 'PDF' && 'ðŸ“„'}
                          {file.type === 'EXCEL' && 'ðŸ“Š'}
                          {file.type === 'ZIP' && 'ðŸ—‚ï¸'}
                          {!['PDF', 'EXCEL', 'ZIP'].includes(file.type) && 'ðŸ“‹'}
                          {file.type === 'PDF' && 'ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã¢â‚¬Å¾'}
                          {file.type === 'EXCEL' && 'ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã…Â '}
                          {file.type === 'ZIP' && 'ÃƒÂ°Ã…Â¸Ã¢â‚¬â€Ã¢â‚¬Å¡ÃƒÂ¯Ã‚Â¸Ã‚Â'}
                          {!['PDF', 'EXCEL', 'ZIP'].includes(file.type) && 'ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã¢â‚¬Â¹'}
                        </div>
                        <div>
