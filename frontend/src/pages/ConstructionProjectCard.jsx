...
const text = {
  ...
  spanish: {
    title: "Financiamiento de Proyecto de ConstrucciÃ³n (Ciudadanos EE.UU.)",
    subtitle: "Financie su proyecto de construcciÃ³n en MÃ©xico (Colateral en EE.UU. aceptado)",
    fullName: "Nombre Completo",
    email: "Correo ElectrÃ³nico",
    phone: "NÃºmero de TelÃ©fono",
    projectAddress: "DirecciÃ³n del Proyecto en MÃ©xico",
    projectType: "Tipo de Proyecto",
    projectCost: "Costo Estimado del Proyecto (USD)",
    landOwned: "Â¿Es dueÃ±o del terreno?",
    title: "Financiamiento de Proyecto de ConstrucciÃƒÆ’Ã‚Â³n (Ciudadanos EE.UU.)",
    subtitle: "Financie su proyecto de construcciÃƒÆ’Ã‚Â³n en MÃƒÆ’Ã‚Â©xico (Colateral en EE.UU. aceptado)",
    fullName: "Nombre Completo",
    email: "Correo ElectrÃƒÆ’Ã‚Â³nico",
    phone: "NÃƒÆ’Ã‚Âºmero de TelÃƒÆ’Ã‚Â©fono",
    projectAddress: "DirecciÃƒÆ’Ã‚Â³n del Proyecto en MÃƒÆ’Ã‚Â©xico",
    projectType: "Tipo de Proyecto",
    projectCost: "Costo Estimado del Proyecto (USD)",
    landOwned: "Ãƒâ€šÃ‚Â¿Es dueÃƒÆ’Ã‚Â±o del terreno?",
    ...
    submit: "Enviar Proyecto para RevisiÃ³n",
    thankyou: "Â¡Gracias! Nuestro equipo de financiamiento se comunicarÃ¡."
    submit: "Enviar Proyecto para RevisiÃƒÆ’Ã‚Â³n",
    thankyou: "Ãƒâ€šÃ‚Â¡Gracias! Nuestro equipo de financiamiento se comunicarÃƒÆ’Ã‚Â¡."
  }
};
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          <div>
            ...
            >
              ...
              <option value="yes">{language === "english" ? "Yes" : "SÃ­"}</option>
              <option value="yes">{language === "english" ? "Yes" : "SÃƒÆ’Ã‚Â­"}</option>
