  ...
  const fetchAvailableCommodities = async () => {
    ...
    try {
      setCommodities([
        ...
        'PEPPERS', 'BELL PEPPERS', 'JALAPEÃ‘OS', 'HABANEROS',
        'PEPPERS', 'BELL PEPPERS', 'JALAPEÃƒÆ’Ã¢â‚¬ËœOS', 'HABANEROS',
  ...
  return (
    <div className="max-w-[95%] mx-auto p-6 space-y-6">
      <div className="bg-gradient-to-r from-green-600 to-green-700 text-white rounded-lg shadow-lg p-6">
        <h1 className="text-3xl font-bold mb-2">ðŸŒ½ USDA Pricing Comparison & Analytics</h1>
        <p className="text-green-100">100+ Products â€¢ Regional Pricing â€¢ Market Analytics</p>
        <h1 className="text-3xl font-bold mb-2">ÃƒÂ°Ã…Â¸Ã…â€™Ã‚Â½ USDA Pricing Comparison & Analytics</h1>
        <p className="text-green-100">100+ Products ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Regional Pricing ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Market Analytics</p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-lg p-2 flex gap-2">
        ...
        >
          ðŸ’° Pricing vs Cost Comparison
          ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Â° Pricing vs Cost Comparison
        </button>
        <button
        ...
        >
          ...
          ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã…Â  Market Analytics
        </button>
      </div>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-3 gap-6">
            <div className="bg-blue-50 rounded-lg shadow-lg p-6 border-l-4 border-blue-500">
              <h3 className="text-lg font-bold text-blue-900 mb-4">ðŸŒŠ West Coast</h3>
              <h3 className="text-lg font-bold text-blue-900 mb-4">ÃƒÂ°Ã…Â¸Ã…â€™Ã…Â  West Coast</h3>
            ...
            <div className="bg-orange-50 rounded-lg shadow-lg p-6 border-l-4 border-orange-500">
              <h3 className="text-lg font-bold text-orange-900 mb-4">ðŸŒ¾ Midwest</h3>
              <h3 className="text-lg font-bold text-orange-900 mb-4">ÃƒÂ°Ã…Â¸Ã…â€™Ã‚Â¾ Midwest</h3>
              <div className="space-y-3">
                <div>
                  <div className="text-xs text-gray-600">Wholesale Price</div>
            ...
            <div className="bg-purple-50 rounded-lg shadow-lg p-6 border-l-4 border-purple-500">
              <h3 className="text-lg font-bold text-purple-900 mb-4">ðŸ™ï¸ East Coast</h3>
              <h3 className="text-lg font-bold text-purple-900 mb-4">ÃƒÂ°Ã…Â¸Ã‚ÂÃ¢â€žÂ¢ÃƒÂ¯Ã‚Â¸Ã‚Â East Coast</h3>
              <div className="space-y-3">
                <div>
                  <div className="text-xs text-gray-600">Wholesale Price</div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              {commodities.slice(0, 30).map(commodity => (
                ...
                >
                  {commodity} {selectedCommodities.includes(commodity) && 'âœ“'}
                  {commodity} {selectedCommodities.includes(commodity) && 'ÃƒÂ¢Ã…â€œÃ¢â‚¬Å“'}
                </button>
              ))}
            </div>
