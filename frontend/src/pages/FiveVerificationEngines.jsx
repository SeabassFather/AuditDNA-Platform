...
const VERIFICATION_SYSTEMS = {
  ...
  senasica: {
    ...
    totalRecords: '15,000+',
    icon: 'ðŸ‡²ðŸ‡½',
    icon: 'ÃƒÂ°Ã…Â¸Ã¢â‚¬Â¡Ã‚Â²ÃƒÂ°Ã…Â¸Ã¢â‚¬Â¡Ã‚Â½',
    color: 'red',
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto space-y-6">
        <div className="bg-green-600 text-white p-8 rounded-xl">
          <h1 className="text-4xl font-bold mb-2">ðŸ” Real-Time Certification Verification</h1>
          <p className="text-green-100">5 databases â€¢ 733,000+ records â€¢ Full intel & sharing</p>
          <h1 className="text-4xl font-bold mb-2">ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â Real-Time Certification Verification</h1>
          <p className="text-green-100">5 databases ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ 733,000+ records ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Full intel & sharing</p>
        </div>
              ...
              {searchResults.found ? (
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="text-2xl font-bold text-green-800">âœ“ VERIFIED & CERTIFIED</h3>
                        <h3 className="text-2xl font-bold text-green-800">ÃƒÂ¢Ã…â€œÃ¢â‚¬Å“ VERIFIED & CERTIFIED</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <div className="text-xs text-gray-500 mt-2">
                          ðŸ“ Coordinates: {searchResults.latitude}, {searchResults.longitude}
                          ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â Coordinates: {searchResults.latitude}, {searchResults.longitude}
                        </div>
                      </div>
                      <div>
                    ...
                    <div className="mt-4 bg-gray-100 rounded-lg overflow-hidden border-2 border-gray-300">
                      ...
                      <div className="bg-blue-600 text-white p-3 flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-bold">ðŸ“ Verified Location: {searchResults.city}, {searchResults.state}</span>
                          <span className="font-bold">ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â Verified Location: {searchResults.city}, {searchResults.state}</span>
                        </div>
                        <a
                  ...
                  <div className="bg-gradient-to-br from-yellow-50 to-orange-50 p-6 rounded-lg border-4 border-orange-400">
                    ...
                    <p className="text-sm text-orange-800 font-semibold mb-4">
                      âš¡ Direct contacts to purchasing team - bypass gatekeepers!
                        <span className="text-3xl">ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Â°</span>
                        <span className="text-orange-800">BUYER/PROCUREMENT CONTACTS</span>
                      </h4>
                      <div className="bg-orange-600 text-white px-4 py-2 rounded-lg font-bold text-sm">
                        ÃƒÂ°Ã…Â¸Ã…Â½Ã‚Â¯ DECISION MAKERS
                      </div>
                    </div>
                    <p className="text-sm text-orange-800 font-semibold mb-4">
                      ÃƒÂ¢Ã…Â¡Ã‚Â¡ Direct contacts to purchasing team - bypass gatekeepers!
                    </p>
                        ...
                        <div key={idx} className="bg-white p-5 rounded-lg border-2 border-orange-200 hover:border-orange-400 transition-all shadow-md">
                          ...
                          <div className="mt-3 flex gap-2">
                            ...
                            <a href={`https://${buyer.linkedIn}`} target="_blank" rel="noopener noreferrer" className="flex-1 bg-purple-600 hover:bg-purple-700 text-white py-2 rounded font-bold text-center text-sm">
                              ðŸ’¼ LinkedIn
                              ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â§ Email Now
                            </a>
                            <a href={`tel:${buyer.directPhone}`} className="flex-1 bg-green-600 hover:bg-green-700 text-white py-2 rounded font-bold text-center text-sm">
                              ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã…Â¾ Call Now
                            </a>
                            <a href={`https://${buyer.linkedIn}`} target="_blank" rel="noopener noreferrer" className="flex-1 bg-purple-600 hover:bg-purple-700 text-white py-2 rounded font-bold text-center text-sm">
                              ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Â¼ LinkedIn
                            </a>
                          </div>
                        </div>
                      ))}
                    ...
                    <div className="mt-4 bg-orange-600 text-white p-4 rounded-lg">
                      ...
                      <p className="font-bold mb-2">ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Â¡ PRO TIP:</p>
                  ...
                  <div className="bg-gradient-to-br from-cyan-50 to-blue-50 p-6 rounded-lg border-4 border-cyan-400">
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="font-bold text-xl flex items-center gap-2">
                        <span className="text-3xl">ðŸ”—</span>
                        <span className="text-3xl">ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ¢â‚¬â€</span>
                    ...
                    <p className="text-sm text-cyan-800 font-semibold mb-4">
                      âš¡ Similar suppliers in the same area - expand your options!
                      ÃƒÂ¢Ã…Â¡Ã‚Â¡ Similar suppliers in the same area - expand your options!
                    </p>
                        ...
                        <div key={idx} className="bg-white p-4 rounded-lg border-2 border-cyan-200 hover:border-cyan-400 hover:shadow-lg transition-all">
                          <div className="flex items-start justify-between mb-2">
                            <div className="flex-1">
                              ...
                              <div className="text-xs text-gray-600 mb-1">ðŸ“ {lead.distance}</div>
                              <div className="text-xs text-gray-600 mb-1">ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â {lead.distance}</div>
                              ...
                              <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className="text-xs bg-orange-100 text-orange-700 px-2 py-1 rounded font-semibold">
                                  âœ“ {lead.matchReason}
                                  ÃƒÂ¢Ã…â€œÃ¢â‚¬Å“ {lead.matchReason}
                                </span>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="bg-cyan-50 p-3 rounded-lg mb-2">
                            <div className="text-xs text-gray-600 mb-1">ðŸ’¼ Buyer Contact</div>
                            ...
                            <div className="grid grid-cols-2 gap-2 text-xs">
                              ...
                              <a href={`tel:${lead.buyerPhone}`} className="text-green-700 hover:underline font-semibold">
                                ðŸ“ž {lead.buyerPhone}
                            <div className="text-xs text-gray-600 mb-1">ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Â¼ Buyer Contact</div>
                            <div className="font-bold text-sm text-gray-900 mb-1">{lead.buyerContact}</div>
                            <div className="grid grid-cols-2 gap-2 text-xs">
                              <a href={`mailto:${lead.buyerEmail}`} className="text-blue-700 hover:underline font-semibold truncate">
                                ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â§ {lead.buyerEmail}
                              </a>
                              <a href={`tel:${lead.buyerPhone}`} className="text-green-700 hover:underline font-semibold">
                                ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã…Â¾ {lead.buyerPhone}
                              </a>
                            </div>
                          </div>
                          ...
                          <div className="flex gap-2">
                            ...
                            >
                              ...
                              ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â View Full Details
                            </button>
                            <a 
                    ...
                    <div className="mt-4 bg-cyan-600 text-white p-4 rounded-lg">
                      <p className="font-bold mb-2">ðŸ’¡ WHY CROSS-REFERENCE?</p>
                      <p className="font-bold mb-2">ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Â¡ WHY CROSS-REFERENCE?</p>
                      <ul className="text-sm space-y-1 list-disc list-inside">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-red-600 mt-2">âš ï¸ DO NOT PROCEED - Supplier cannot be verified as legal</p>
                    <p className="text-sm text-red-600 mt-2">ÃƒÂ¢Ã…Â¡Ã‚Â ÃƒÂ¯Ã‚Â¸Ã‚Â DO NOT PROCEED - Supplier cannot be verified as legal</p>
                  </div>
                </div>
              )}
            </div>
