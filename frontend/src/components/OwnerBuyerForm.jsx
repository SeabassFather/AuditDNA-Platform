...
const text = {
  ...
  spanish: {
    ...
    subtitle: "Ãƒâ€šÃ‚Â¿Necesita ayuda para vender o comprar una propiedad? Complete el formulario y nuestro equipo lo contactarÃƒÆ’Ã‚Â¡.",
    fullName: "Nombre Completo",
    email: "Correo ElectrÃƒÆ’Ã‚Â³nico",
    phone: "TelÃƒÆ’Ã‚Â©fono",
    propertyType: "Tipo de Propiedad",
    address: "DirecciÃƒÆ’Ã‚Â³n de la Propiedad",
    price: "Precio Solicitado (USD)",
    upload: "Subir Fotos de la Propiedad",
    submit: "Enviar Solicitud",
    thankyou: "Ãƒâ€šÃ‚Â¡Gracias! Nuestro equipo lo contactarÃƒÆ’Ã‚Â¡ pronto.",
    required: "es requerido",
    invalidEmail: "Correo electrÃƒÆ’Ã‚Â³nico no vÃƒÆ’Ã‚Â¡lido",
    invalidPrice: "Se requiere un precio solicitado vÃƒÆ’Ã‚Â¡lido"
    subtitle: "ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿Necesita ayuda para vender o comprar una propiedad? Complete el formulario y nuestro equipo lo contactarÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡.",
    fullName: "Nombre Completo",
    email: "Correo ElectrÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³nico",
    phone: "TelÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©fono",
    propertyType: "Tipo de Propiedad",
    address: "DirecciÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³n de la Propiedad",
    price: "Precio Solicitado (USD)",
    upload: "Subir Fotos de la Propiedad",
    submit: "Enviar Solicitud",
    thankyou: "ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡Gracias! Nuestro equipo lo contactarÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡ pronto.",
    required: "es requerido",
    invalidEmail: "Correo electrÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³nico no vÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡lido",
    invalidPrice: "Se requiere un precio solicitado vÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡lido"
  }
};
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder={language === 'english' ? "Jane Doe" : "Juan PÃƒÆ’Ã‚Â©rez"}
              placeholder={language === 'english' ? "Jane Doe" : "Juan PÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©rez"}
          ...
          <div>
            ...
            <input
              ...
              value={form.address}
              onChange={handleChange}
              placeholder={language === 'english' ? "123 Main St, City, Country" : "Av. Principal 123, Ciudad, PaÃƒÆ’Ã‚Â­s"}
              placeholder={language === 'english' ? "123 Main St, City, Country" : "Av. Principal 123, Ciudad, PaÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â­s"}
