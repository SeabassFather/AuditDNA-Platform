...
function MexicoRefiCard({ language = "english" }) {
  ...
  const validate = () => {
    ...
    if (!form.email.trim()) {
      ...
      errs.email = language === "english" ? "Email is invalid" : "El correo electrÃ³nico no es vÃ¡lido";
      errs.email = language === "english" ? "Email is invalid" : "El correo electrÃƒÆ’Ã‚Â³nico no es vÃƒÆ’Ã‚Â¡lido";
    }
          ...
          <div>
            ...
            <input
              ...
              placeholder={
                language === "english"
                  ? "Mexico, Address"
                  : "DirecciÃ³n en MÃ©xico"
                  : "DirecciÃƒÆ’Ã‚Â³n en MÃƒÆ’Ã‚Â©xico"
              }
              className={`w-full px-4 py-3 border-2 rounded-lg focus:ring-2 focus:ring-purple-500 ${
            ...
            <textarea
              ...
              placeholder={
                language === "english"
                  ...
                  : "CuÃ©ntenos mÃ¡s sobre sus necesidades..."
                  : "CuÃƒÆ’Ã‚Â©ntenos mÃƒÆ’Ã‚Â¡s sobre sus necesidades..."
              }
