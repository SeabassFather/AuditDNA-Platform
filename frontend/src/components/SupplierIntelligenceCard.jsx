      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '24px' }}>
        <div style={{ background: '#fff', borderRadius: '12px', boxShadow: '0 4px 6px rgba(0,0,0,0.1)', padding: '40px', textAlign: 'center' }}>
          <h1 style={{ fontSize: '36px', fontWeight: 'bold', color: '#1f2937', marginBottom: '16px' }}>
            ðŸŽ¯ Supplier Intelligence Search
            ÃƒÂ°Ã…Â¸Ã…Â½Ã‚Â¯ Supplier Intelligence Search
          </h1>
          ...
          <div style={{ maxWidth: '700px', margin: '0 auto', marginBottom: '32px' }}>
            <div style={{ display: 'flex', gap: '12px' }}>
              ...
              >
                ...
                {isSearching ? 'ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â Searching...' : 'ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â Search'}
              </button>
            </div>
          </div>
          ...
          <div style={{ marginTop: '48px', display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '24px', textAlign: 'left' }}>
            <div style={{ padding: '24px', background: '#f9fafb', borderRadius: '8px' }}>
              ...
              <div style={{ fontSize: '32px', marginBottom: '12px' }}>ÃƒÂ°Ã…Â¸Ã¢â‚¬ËœÃ‚Â¥</div>
            ...
            <div style={{ padding: '24px', background: '#f9fafb', borderRadius: '8px' }}>
              ...
              <div style={{ fontSize: '32px', marginBottom: '12px' }}>ÃƒÂ°Ã…Â¸Ã…Â¡Ã‚Â¢</div>
            ...
            <div style={{ padding: '24px', background: '#f9fafb', borderRadius: '8px' }}>
              ...
              <div style={{ fontSize: '32px', marginBottom: '12px' }}>ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã…Â </div>
              ...
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
                  <div>
                    ...
                    <div style={{ display: 'flex', gap: '16px', fontSize: '14px', color: '#6b7280', marginBottom: '12px' }}>
                      ...
                      <span>ðŸ¢ Est. {supplier.established}</span>
                      <span>ðŸ’° {supplier.annualRevenue}</span>
                      <span>ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â {supplier.location}</span>
                      <span>ÃƒÂ°Ã…Â¸Ã‚ÂÃ‚Â¢ Est. {supplier.established}</span>
                      <span>ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Â° {supplier.annualRevenue}</span>
                    </div>
                ...
                <div style={{ marginTop: '12px', textAlign: 'right' }}>
                  <button style={{ padding: '8px 16px', background: '#2563eb', color: '#fff', border: 'none', borderRadius: '6px', fontSize: '14px', fontWeight: 'bold' }}>
                    ...
                    View Full Intelligence ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢
                  </button>
                </div>
              </div>
            );
    ...
    <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '24px' }}>
      ...
      <div style={{ background: '#fff', borderRadius: '12px', boxShadow: '0 4px 6px rgba(0,0,0,0.1)' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
            <div>
              ...
              <div style={{ display: 'flex', gap: '24px', fontSize: '14px', opacity: 0.9 }}>
                ...
                <span>ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â {supplier.location}</span>
                <span>ÃƒÂ°Ã…Â¸Ã‚ÂÃ‚Â¢ Est. {supplier.established}</span>
                <span>ÃƒÂ°Ã…Â¸Ã…â€™Ã‚Â {supplier.exportVolume}</span>
              </div>
            </div>
            <div style={{ 
              padding: '12px 24px', 
        ...
        <div style={{ padding: '24px', borderTop: '1px solid #e5e7eb' }}>
          ...
          >
            <span>ðŸ‘¥ Smart Contact Directory</span>
            <span>{expandedSections.contacts ? 'â–²' : 'â–¼'}</span>
            <span>ÃƒÂ°Ã…Â¸Ã¢â‚¬ËœÃ‚Â¥ Smart Contact Directory</span>
            <span>{expandedSections.contacts ? 'ÃƒÂ¢Ã¢â‚¬â€œÃ‚Â²' : 'ÃƒÂ¢Ã¢â‚¬â€œÃ‚Â¼'}</span>
          </button>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <div>
                <h3 style={{ fontSize: '16px', fontWeight: 'bold', color: '#374151', marginBottom: '12px' }}>
                  ...
                  ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Â¼ PURCHASING & ORDERS
                </h3>
                {supplier.contacts.commercial.map((contact, idx) => (
                  <div key={idx} style={{ 
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
                      <div>
                        <div style={{ fontWeight: 'bold', fontSize: '16px' }}>
                          {contact.name} {contact.preferredContact && <span style={{ fontSize: '11px', background: '#059669', color: '#fff', padding: '2px 8px', borderRadius: '10px' }}>â­ PREFERRED</span>}
                          {contact.name} {contact.preferredContact && <span style={{ fontSize: '11px', background: '#059669', color: '#fff', padding: '2px 8px', borderRadius: '10px' }}>ÃƒÂ¢Ã‚Â­Ã‚Â PREFERRED</span>}
                        </div>
                    ...
                    <div style={{ background: '#fff', padding: '12px', borderRadius: '6px', marginBottom: '8px', fontSize: '12px' }}>
                      <strong>âœ… Authorized for:</strong> {contact.authorizedFor.join(', ')}
                    </div>
                    <div style={{ display: 'flex', gap: '8px' }}>
                      ...
                      <button onClick={() => handleGenerateQR(contact)} style={{ padding: '6px 12px', background: '#7c3aed', color: '#fff', border: 'none', borderRadius: '4px', fontSize: '12px', cursor: 'pointer' }}>
                        ðŸ“± QR Code
                      ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â§ {contact.email} | ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â± {contact.phone}
                    </div>
                    <div style={{ background: '#fff', padding: '12px', borderRadius: '6px', marginBottom: '8px', fontSize: '12px' }}>
                      <strong>ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Authorized for:</strong> {contact.authorizedFor.join(', ')}
                    </div>
                    <div style={{ display: 'flex', gap: '8px' }}>
                      <button onClick={() => handleSendEmail(contact, 'PO')} style={{ padding: '6px 12px', background: '#2563eb', color: '#fff', border: 'none', borderRadius: '4px', fontSize: '12px', cursor: 'pointer' }}>
                        ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â§ Send PO
                      </button>
                      <button onClick={() => handleGenerateQR(contact)} style={{ padding: '6px 12px', background: '#7c3aed', color: '#fff', border: 'none', borderRadius: '4px', fontSize: '12px', cursor: 'pointer' }}>
              ...
              <div>
                <h3 style={{ fontSize: '16px', fontWeight: 'bold', color: '#374151', marginBottom: '12px' }}>
                  ðŸ’° FINANCE & PAYMENTS
                  ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Â° FINANCE & PAYMENTS
                </h3>
                {supplier.contacts.financial.map((contact, idx) => (
                  <div key={idx} style={{ background: '#fef3c7', padding: '16px', borderRadius: '8px', borderLeft: '4px solid #d97706' }}>
                    <div style={{ fontWeight: 'bold', fontSize: '16px', marginBottom: '4px' }}>
                      {contact.name} {contact.confidential && <span style={{ fontSize: '11px', background: '#dc2626', color: '#fff', padding: '2px 8px', borderRadius: '10px' }}>ðŸ”’ CONFIDENTIAL</span>}
                    </div>
                    ...
                    <button onClick={() => handleSendEmail(contact, 'Factoring')} style={{ padding: '6px 12px', background: '#d97706', color: '#fff', border: 'none', borderRadius: '4px', fontSize: '12px', cursor: 'pointer' }}>
                      ðŸ’³ Propose Factoring
                      {contact.name} {contact.confidential && <span style={{ fontSize: '11px', background: '#dc2626', color: '#fff', padding: '2px 8px', borderRadius: '10px' }}>ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ¢â‚¬â„¢ CONFIDENTIAL</span>}
                    </div>
                    <div style={{ fontSize: '13px', color: '#6b7280', marginBottom: '8px' }}>{contact.title}</div>
                    <div style={{ fontSize: '13px', marginBottom: '8px' }}>
                      ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â§ {contact.email} | ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â± {contact.phone}
                    ...
                    <button onClick={() => handleSendEmail(contact, 'Factoring')} style={{ padding: '6px 12px', background: '#d97706', color: '#fff', border: 'none', borderRadius: '4px', fontSize: '12px', cursor: 'pointer' }}>
                      ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Â³ Propose Factoring
                    </button>
                  </div>
                ))}
              </div>
      ...
      {qrModal && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000 }}>
          <div style={{ background: '#fff', padding: '24px', borderRadius: '12px', textAlign: 'center', maxWidth: '400px' }}>
            <h2 style={{ marginBottom: '16px' }}>ðŸ“± QR Code</h2>
            <h2 style={{ marginBottom: '16px' }}>ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â± QR Code</h2>
