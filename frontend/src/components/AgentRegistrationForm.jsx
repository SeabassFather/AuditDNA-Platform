...
const text = {
  ...
  spanish: {
    ...
    subtitle: "Ãšnase a la Plataforma Elite de Bienes RaÃ­ces AuditDNA",
    alertTitle: "Registro Requerido Antes de Subir Propiedades",
    alertText: "Todos los campos son obligatorios. Debe completar este registro antes de poder subir propiedades a la plataforma. Su informaciÃ³n serÃ¡ verificada antes de la aprobaciÃ³n.",
    formTitle: "Formulario de CalificaciÃ³n de Agente",
    formSubtitle: "Por favor proporcione informaciÃ³n precisa",
    fullName: "Nombre Completo",
    email: "Correo ElectrÃ³nico",
    phone: "NÃºmero de TelÃ©fono",
    agency: "Nombre de la Agencia",
    terms: "Al registrarse, acepta cumplir con todos los tÃ©rminos y condiciones de la plataforma, incluido el acuerdo de divisiÃ³n de comisiÃ³n 50/50 en todas las transacciones. Certifica que toda la informaciÃ³n proporcionada es precisa y que tiene la autoridad para listar propiedades en nombre de los propietarios.",
    submit: "Completar Registro",
    questions: "Â¿Preguntas sobre el registro?",
    contact: "Contacto: support@auditdna.com",
    required: "es requerido",
    invalidEmail: "El correo electrÃ³nico no es vÃ¡lido",
    invalidPhone: "El nÃºmero de telÃ©fono no es vÃ¡lido",
    // Refi
    refiTitle: "Refinanciamiento / Compra en MÃ©xico (Solo Ciudadanos USA)",
    refiSubtitle: "Exclusivo para ciudadanos estadounidenses que buscan refinanciar o comprar casa en MÃ©xico. PrÃ©stamo mÃ­nimo: $385,000 USD. Anticipo requerido: 35-45%. Aplican otras restricciones.",
    propertyType: "Tipo de Propiedad",
    address: "DirecciÃ³n de la Propiedad en MÃ©xico",
    downPayment: "Anticipo (%)",
    loanAmount: "Monto de PrÃ©stamo Deseado (USD)",
    notes: "Notas Adicionales / Preguntas",
    refiSubmit: "Enviar Solicitud de CrÃ©dito/Refinanciamiento",
    refiThankyou: "Â¡Gracias! Nuestro equipo de crÃ©dito se comunicarÃ¡ para los siguientes pasos.",
    invalidLoan: "El monto mÃ­nimo de prÃ©stamo es $385,000 USD",
    subtitle: "ÃƒÆ’Ã…Â¡nase a la Plataforma Elite de Bienes RaÃƒÆ’Ã‚Â­ces AuditDNA",
    alertTitle: "Registro Requerido Antes de Subir Propiedades",
    alertText: "Todos los campos son obligatorios. Debe completar este registro antes de poder subir propiedades a la plataforma. Su informaciÃƒÆ’Ã‚Â³n serÃƒÆ’Ã‚Â¡ verificada antes de la aprobaciÃƒÆ’Ã‚Â³n.",
    formTitle: "Formulario de CalificaciÃƒÆ’Ã‚Â³n de Agente",
    formSubtitle: "Por favor proporcione informaciÃƒÆ’Ã‚Â³n precisa",
    fullName: "Nombre Completo",
    email: "Correo ElectrÃƒÆ’Ã‚Â³nico",
    phone: "NÃƒÆ’Ã‚Âºmero de TelÃƒÆ’Ã‚Â©fono",
    agency: "Nombre de la Agencia",
    terms: "Al registrarse, acepta cumplir con todos los tÃƒÆ’Ã‚Â©rminos y condiciones de la plataforma, incluido el acuerdo de divisiÃƒÆ’Ã‚Â³n de comisiÃƒÆ’Ã‚Â³n 50/50 en todas las transacciones. Certifica que toda la informaciÃƒÆ’Ã‚Â³n proporcionada es precisa y que tiene la autoridad para listar propiedades en nombre de los propietarios.",
    submit: "Completar Registro",
    questions: "Ãƒâ€šÃ‚Â¿Preguntas sobre el registro?",
    contact: "Contacto: support@auditdna.com",
    required: "es requerido",
    invalidEmail: "El correo electrÃƒÆ’Ã‚Â³nico no es vÃƒÆ’Ã‚Â¡lido",
    invalidPhone: "El nÃƒÆ’Ã‚Âºmero de telÃƒÆ’Ã‚Â©fono no es vÃƒÆ’Ã‚Â¡lido",
    // Refi
    refiTitle: "Refinanciamiento / Compra en MÃƒÆ’Ã‚Â©xico (Solo Ciudadanos USA)",
    refiSubtitle: "Exclusivo para ciudadanos estadounidenses que buscan refinanciar o comprar casa en MÃƒÆ’Ã‚Â©xico. PrÃƒÆ’Ã‚Â©stamo mÃƒÆ’Ã‚Â­nimo: $385,000 USD. Anticipo requerido: 35-45%. Aplican otras restricciones.",
    propertyType: "Tipo de Propiedad",
    address: "DirecciÃƒÆ’Ã‚Â³n de la Propiedad en MÃƒÆ’Ã‚Â©xico",
    downPayment: "Anticipo (%)",
    loanAmount: "Monto de PrÃƒÆ’Ã‚Â©stamo Deseado (USD)",
    notes: "Notas Adicionales / Preguntas",
    refiSubmit: "Enviar Solicitud de CrÃƒÆ’Ã‚Â©dito/Refinanciamiento",
    refiThankyou: "Ãƒâ€šÃ‚Â¡Gracias! Nuestro equipo de crÃƒÆ’Ã‚Â©dito se comunicarÃƒÆ’Ã‚Â¡ para los siguientes pasos.",
    invalidLoan: "El monto mÃƒÆ’Ã‚Â­nimo de prÃƒÆ’Ã‚Â©stamo es $385,000 USD",
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          <div>
            ...
            <input
              ...
              placeholder={language === "english" ? "John Doe" : "Juan PÃ©rez"}
              placeholder={language === "english" ? "John Doe" : "Juan PÃƒÆ’Ã‚Â©rez"}
          ...
          <div>
            ...
            <input
              ...
              value={form.address}
              onChange={handleChange}
              placeholder={language === "english" ? "Mexico, Address" : "DirecciÃ³n en MÃ©xico"}
              placeholder={language === "english" ? "Mexico, Address" : "DirecciÃƒÆ’Ã‚Â³n en MÃƒÆ’Ã‚Â©xico"}
          ...
          <div>
            ...
            <textarea
              ...
              value={form.notes}
              onChange={handleChange}
              placeholder={language === "english" ? "Tell us more about your needs..." : "CuÃ©ntenos mÃ¡s sobre sus necesidades..."}
              placeholder={language === "english" ? "Tell us more about your needs..." : "CuÃƒÆ’Ã‚Â©ntenos mÃƒÆ’Ã‚Â¡s sobre sus necesidades..."}
