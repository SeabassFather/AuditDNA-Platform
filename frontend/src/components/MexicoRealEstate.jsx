...
export default function MexicoRealEstateAccordion() {
  ...
  const labels = {
    english: {
      ...
      sub: "Bienes RaÃ­ces en MÃ©xico â€¢ Full Service Platform",
      sub: "Bienes RaÃƒÆ’Ã‚Â­ces en MÃƒÆ’Ã‚Â©xico ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Full Service Platform",
    ...
    spanish: {
      header: "Bienes RaÃ­ces MÃ©xico",
      sub: "Mexico Real Estate â€¢ Plataforma de Servicio Completo",
      search: "Buscar Propiedades",
      // contactOwner: "Contactar al Propietario", // Removed
      buyerForm: "Solicitud de InformaciÃ³n / InterÃ©s de Compra",
      upload: "Publicar Propiedad",
      refi: "Refinanciamiento / Compra en MÃ©xico (Solo Ciudadanos USA)",
      partner: "Registro de Socio de Referencia",
      agent: "Registro de Agente",
      appraisal: "Servicios de AvalÃºo",
      legal: "Cuestionario Legal/Fideicomiso",
      contact: "InformaciÃ³n de Contacto",
      toggle: "EspaÃƒÆ’Ã‚Â±ol",
    },
    spanish: {
      header: "Bienes RaÃƒÆ’Ã‚Â­ces MÃƒÆ’Ã‚Â©xico",
      sub: "Mexico Real Estate ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Plataforma de Servicio Completo",
      search: "Buscar Propiedades",
      // contactOwner: "Contactar al Propietario", // Removed
      buyerForm: "Solicitud de InformaciÃƒÆ’Ã‚Â³n / InterÃƒÆ’Ã‚Â©s de Compra",
      upload: "Publicar Propiedad",
      refi: "Refinanciamiento / Compra en MÃƒÆ’Ã‚Â©xico (Solo Ciudadanos USA)",
      partner: "Registro de Socio de Referencia",
      agent: "Registro de Agente",
      appraisal: "Servicios de AvalÃƒÆ’Ã‚Âºo",
      legal: "Cuestionario Legal/Fideicomiso",
      contact: "InformaciÃƒÆ’Ã‚Â³n de Contacto",
      toggle: "English",
    },
  };
