...
const text = {
  ...
  spanish: {
    ...
    subtitle: "El acceso a este mÃ³dulo requiere aprobaciÃ³n.",
    ...
    pending: "Su solicitud de acceso estÃ¡ pendiente de aprobaciÃ³n por el administrador. RecibirÃ¡ un correo electrÃ³nico o SMS una vez aprobado.",
    error: "OcurriÃ³ un error. IntÃ©ntelo de nuevo o contacte soporte."
    subtitle: "El acceso a este mÃƒÆ’Ã‚Â³dulo requiere aprobaciÃƒÆ’Ã‚Â³n.",
    fullName: "Nombre completo",
    ...
    reason: "Motivo de acceso",
    submit: "Solicitar acceso",
    pending: "Su solicitud de acceso estÃƒÆ’Ã‚Â¡ pendiente de aprobaciÃƒÆ’Ã‚Â³n por el administrador. RecibirÃƒÆ’Ã‚Â¡ un correo electrÃƒÆ’Ã‚Â³nico o SMS una vez aprobado.",
    error: "OcurriÃƒÆ’Ã‚Â³ un error. IntÃƒÆ’Ã‚Â©ntelo de nuevo o contacte soporte."
  }
};
