...
const AUDIT_CATEGORIES = {
  ...
  "Agriculture & Trade": {
    ...
    services: [
      ...
      {
        id: "AGR002",
        name: "Mexico Grower â†’ U.S. Buyer Matching",
        name: "Mexico Grower ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ U.S. Buyer Matching",
        price: "$499/match",
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between text-xs text-gray-500">
        <span>â±ï¸ {service.timeframe}</span>
        <span className="text-blue-600 font-semibold group-hover:underline">Request Audit â†’</span>
        <span>ÃƒÂ¢Ã‚ÂÃ‚Â±ÃƒÂ¯Ã‚Â¸Ã‚Â {service.timeframe}</span>
        <span className="text-blue-600 font-semibold group-hover:underline">Request Audit ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢</span>
      </div>
    </div>
  );
}
        ...
        <div className="text-center mb-12">
          ...
          <div className="mt-6 flex justify-center gap-8 text-sm">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl">ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦</span>
              <span className="font-semibold">90%+ Success Rate</span>
            </div>
            <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              <span className="text-2xl">ÃƒÂ¢Ã…Â¡Ã‚Â¡</span>
