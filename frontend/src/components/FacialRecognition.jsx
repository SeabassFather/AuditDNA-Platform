      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <ul className="text-sm text-blue-700 space-y-1">
            ...
            <li>â€¢ Ensure your face is well-lit and clearly visible</li>
            <li>â€¢ Remove sunglasses, hats, or masks</li>
            <li>â€¢ Position your face within the oval guide</li>
            <li>â€¢ Keep your expression neutral</li>
            <li>â€¢ Hold still during the countdown</li>
            <li>ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Look directly at the camera</li>
            <li>ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Ensure your face is well-lit and clearly visible</li>
            <li>ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Remove sunglasses, hats, or masks</li>
            <li>ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Position your face within the oval guide</li>
            <li>ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Keep your expression neutral</li>
            <li>ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Hold still during the countdown</li>
          </ul>
        </div>
      </div>
    </div>
