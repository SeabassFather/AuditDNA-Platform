...
const text = {
  ...
  spanish: {
    ...
    subtitle: "AsÃƒÆ’Ã‚Â³ciese con AuditDNA para PrÃƒÆ’Ã‚Â©stamos y Bienes RaÃƒÆ’Ã‚Â­ces en MÃƒÆ’Ã‚Â©xico",
    org: "Nombre de la OrganizaciÃƒÆ’Ã‚Â³n",
    contact: "Nombre del Contacto",
    email: "Correo ElectrÃƒÆ’Ã‚Â³nico",
    phone: "NÃƒÆ’Ã‚Âºmero de TelÃƒÆ’Ã‚Â©fono",
    role: "Tipo de Socio",
    dealVolume: "Referencias/Negocios por AÃƒÆ’Ã‚Â±o",
    regions: "Regiones Cubiertas",
    coBrand: "Ãƒâ€šÃ‚Â¿Interesado en Co-Branding?",
    uploadPhotos: "Subir Fotos (opcional)",
    uploadDocs: "Subir Documentos Legales (opcional)",
    uploadLogo: "Subir Logo de la OrganizaciÃƒÆ’Ã‚Â³n (opcional)",
    notes: "Notas / Comentarios Adicionales",
    submit: "Registrarse como Socio",
    thankyou: "Ãƒâ€šÃ‚Â¡Gracias! Nuestro equipo de alianzas le contactarÃƒÆ’Ã‚Â¡."
    subtitle: "AsÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³ciese con AuditDNA para PrÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©stamos y Bienes RaÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â­ces en MÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©xico",
    org: "Nombre de la OrganizaciÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³n",
    contact: "Nombre del Contacto",
    email: "Correo ElectrÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³nico",
    phone: "NÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Âºmero de TelÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©fono",
    role: "Tipo de Socio",
    dealVolume: "Referencias/Negocios por AÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â±o",
    regions: "Regiones Cubiertas",
    coBrand: "ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿Interesado en Co-Branding?",
    uploadPhotos: "Subir Fotos (opcional)",
    uploadDocs: "Subir Documentos Legales (opcional)",
    uploadLogo: "Subir Logo de la OrganizaciÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³n (opcional)",
    notes: "Notas / Comentarios Adicionales",
    submit: "Registrarse como Socio",
    thankyou: "ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡Gracias! Nuestro equipo de alianzas le contactarÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡."
  }
};
