...
const text = {
  ...
  spanish: {
    title: "Solicitar Servicios de AvalÃºo",
    subtitle: "Solicite un avalÃºo certificado para propiedad en MÃ©xico o EE.UU.",
    fullName: "Nombre Completo",
    email: "Correo ElectrÃ³nico",
    phone: "NÃºmero de TelÃ©fono",
    propertyAddress: "Domicilio de la Propiedad",
    propertyType: "Tipo de Propiedad",
    purpose: "PropÃ³sito del AvalÃºo",
    notes: "Notas / Preguntas Adicionales",
    uploadPhotos: "Subir Fotos (opcional)",
    uploadDocs: "Subir Documentos Legales (opcional)",
    submit: "Solicitar AvalÃºo",
    thankyou: "Â¡Gracias! Nuestro equipo de avalÃºos le contactarÃ¡ con los siguientes pasos."
    title: "Solicitar Servicios de AvalÃƒÆ’Ã‚Âºo",
    subtitle: "Solicite un avalÃƒÆ’Ã‚Âºo certificado para propiedad en MÃƒÆ’Ã‚Â©xico o EE.UU.",
    fullName: "Nombre Completo",
    email: "Correo ElectrÃƒÆ’Ã‚Â³nico",
    phone: "NÃƒÆ’Ã‚Âºmero de TelÃƒÆ’Ã‚Â©fono",
    propertyAddress: "Domicilio de la Propiedad",
    propertyType: "Tipo de Propiedad",
    purpose: "PropÃƒÆ’Ã‚Â³sito del AvalÃƒÆ’Ã‚Âºo",
    notes: "Notas / Preguntas Adicionales",
    uploadPhotos: "Subir Fotos (opcional)",
    uploadDocs: "Subir Documentos Legales (opcional)",
    submit: "Solicitar AvalÃƒÆ’Ã‚Âºo",
    thankyou: "Ãƒâ€šÃ‚Â¡Gracias! Nuestro equipo de avalÃƒÆ’Ã‚Âºos le contactarÃƒÆ’Ã‚Â¡ con los siguientes pasos."
  }
};
...
const PURPOSES = [
  ...
  {en: "Estate Planning", es: "PlanificaciÃ³n Patrimonial"},
  {en: "Estate Planning", es: "PlanificaciÃƒÆ’Ã‚Â³n Patrimonial"},
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-2 border-2 rounded-lg focus:ring-2 focus:ring-green-300"
            >
              <option value="">{language === "english" ? "Select purpose" : "Seleccione propÃ³sito"}</option>
              <option value="">{language === "english" ? "Select purpose" : "Seleccione propÃƒÆ’Ã‚Â³sito"}</option>
