      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <ul className="text-sm text-blue-700 space-y-1">
            ...
            <li>â€¢ Hold the document flat and straight</li>
            <li>â€¢ Position the entire document within the frame</li>
            <li>â€¢ Avoid shadows and glare on the document</li>
            <li>â€¢ Use a contrasting background (e.g., dark document on light surface)</li>
            <li>ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Ensure good lighting for best results</li>
            <li>ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Hold the document flat and straight</li>
            <li>ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Position the entire document within the frame</li>
            <li>ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Avoid shadows and glare on the document</li>
            <li>ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Use a contrasting background (e.g., dark document on light surface)</li>
          </ul>
        </div>
      </div>
    </div>
