    ...
    <div style={{
      ...
      {submitted ? (
        <div style={{ color: "green", fontWeight: 600 }}>
          âœ… Sent! Check your email for your copy.<br />Weâ€™ll reach out soon!
          ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Sent! Check your email for your copy.<br />WeÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ll reach out soon!
        </div>
      ) : (
