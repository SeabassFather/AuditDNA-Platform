...
export const certificationTypes = [
  ...
  { value: "haccp", label: "HACCP", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â¬", color: "teal" },
  { value: "senasica", label: "SENASICA (Mexico)", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬Â¡Ã‚Â²ÃƒÂ°Ã…Â¸Ã¢â‚¬Â¡Ã‚Â½", color: "green" },
  { value: "gfsi", label: "GFSI Recognized", icon: "ÃƒÂ°Ã…Â¸Ã‚ÂÃ¢â‚¬Â ", color: "yellow" },
...
export const foodSafetyBadges = [
  ...
  { type: "traceability", label: "Full Traceability", icon: "ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â" },
  { type: "cold-chain", label: "Cold Chain Certified", icon: "ÃƒÂ¢Ã‚ÂÃ¢â‚¬Å¾ÃƒÂ¯Ã‚Â¸Ã‚Â" },
