...
export const growerDatabase = [
  {
    ...
    location: {
      ...
      region: 'MichoacÃ¡n',
      state: 'MichoacÃ¡n',
      region: 'MichoacÃƒÆ’Ã‚Â¡n',
      state: 'MichoacÃƒÆ’Ã‚Â¡n',
      country: 'Mexico',
    ...
    bio: 'Leading Hass avocado producer in MichoacÃ¡n with organic certification and modern processing facilities.'
    bio: 'Leading Hass avocado producer in MichoacÃƒÆ’Ã‚Â¡n with organic certification and modern processing facilities.'
  },
  {
    id: 'GRW-002',
  ...
  {
    id: 'GRW-005',
    companyName: 'Pimientos JalapeÃ±os SA',
    dba: 'JalapeÃ±o King',
    companyName: 'Pimientos JalapeÃƒÆ’Ã‚Â±os SA',
    dba: 'JalapeÃƒÆ’Ã‚Â±o King',
    type: 'grower',
    location: {
      city: 'Delicias',
      region: 'Chihuahua',
    ...
    commodities: ['JalapeÃ±o Peppers', 'Bell Peppers', 'Serrano Peppers'],
    commodities: ['JalapeÃƒÆ’Ã‚Â±o Peppers', 'Bell Peppers', 'Serrano Peppers'],
    organic: false,
    certifications: ['globalgap', 'primusgfs', 'senasica'],
